...
TRABAKUAMALLABIA = {
    ...
    'Salimos de <b>Trabakua</b> en dirección a <b>Zengotitagane</b>, inicialmente hacia el norte. Empezamos a ganar altura por pista y, en lugar de tomar el desvío habitual de la derecha, continuamos de frente. La pista se vuelve algo más rota y trialera, aunque se puede subir sin demasiados problemas.':
        '<b>Trabakua</b>tik <b>Zengotitagane</b>rantz abiatzen gara, hasieran iparralderantz. Pistan gora hasten gara altuera irabazten, eta eskuinerako ohiko desbideratzea hartu beharrean, aurrera segitzen dugu zuzen. Pista puskatuago eta trialerago bihurtzen da, nahiz eta arazo handirik gabe igo daitekeen.',
    'Este primer tramo ya deja bastante claro el carácter de la ruta. Aunque gran parte del recorrido es perfectamente ciclable, iremos buscando algunos caminos y senderos más técnicos y juguetones. Se puede hacer con BTT, pero por el tipo de terreno y los continuos cambios de desnivel, la e-bike es la opción más recomendable para moverse por estas zonas y disfrutar mejor de toda la vuelta.':
        'Lehen tarte honek argi uzten du ibilbidearen izaera. Ibilbidearen zati handi bat ondo pedalatzekoa den arren, tarteka bide eta bidezidor tekniko eta jostagarriagoak bilatuko ditugu. BTTz egin daiteke, baina lurraren motagatik eta etengabeko desnibel-aldaketengatik, e-bikea da gomendagarriena zona hauetatik mugitzeko eta buelta osoa hobeto disfrutatzeko.',
    'Un poco más arriba giramos a la izquierda y dejamos la subida para entrar en un sendero en descenso. Cambiamos completamente de dirección y vamos buscando la zona de <b><a href="osma.html">Osma</a></b> por caminos poco transitados que discurren por encima de la carretera general. Es precisamente uno de los atractivos de este tramo: poder enlazar la zona sin necesidad de circular por la general, utilizando caminos que están ahí pero que pasan bastante desapercibidos.':
        'Pixka bat gorago ezkerrera biratzen dugu eta igoera uzten dugu, jaitsierako bidezidor batean sartzeko. Norabidez erabat aldatzen dugu eta <b><a href="osma.html">Osma</a></b>ren aldera goaz, errepide nagusiaren gainetik doazen bide gutxi erabilietatik. Hain zuzen ere, hori da tarte honen erakargarrietako bat: zona lotu ahal izatea errepide nagusitik ibili beharrik gabe, hor dauden baina oharkabean pasatzen diren bideak erabiliz.',
    'Primero perdemos algo de altura y después volvemos a subir hasta enlazar con la pista que asciende desde Osma hacia Zengotitagane. Al alcanzar el cemento giramos a la derecha y subimos unos 200 metros. En una curva cerrada a la derecha abandonamos nuevamente la pista principal y cogemos las pistas que salen hacia la izquierda.':
        'Lehenengo altuera pixka bat galtzen dugu eta gero berriro igotzen dugu, Osmatik Zengotitaganera igotzen den pistarekin lotu arte. Zementura iristean eskuinera biratzen dugu eta 200 bat metro igotzen dugu. Eskuineko bihurgune itxi batean pista nagusia berriro uzten dugu eta ezkerrera doazen pistak hartzen ditugu.',
    'A partir de aquí comenzamos el descenso hacia el barrio de <b>Zengotita</b>. Vamos enlazando caminos hasta coger el que baja directamente al barrio. Justo a la entrada encontramos una fuente de agua a mano derecha, un buen punto para parar y rellenar los bidones.':
        'Hemendik aurrera <b>Zengotita</b> auzorako jaitsiera hasten dugu. Bideak lotuz goaz, auzora zuzenean jaisten dena hartu arte. Sarreran bertan iturri bat aurkitzen dugu eskuinaldean, geratzeko eta bidoiak betetzeko toki egokia.',
    'Atravesamos Zengotita y continuamos bajando hasta la zona de la ermita, donde enlazamos con la GR. La seguimos pasando por <b>Aitzu</b> y continuamos en dirección a <b>Mallabia</b>. Este tramo es principalmente descendente y bastante sencillo, sin grandes complicaciones técnicas.':
        'Zengotita zeharkatzen dugu eta jaisten jarraitzen dugu ermitaren gunearaino, non GRarekin lotzen garen. Jarraitzen dugu <b>Aitzu</b>tik pasatuz eta <b>Mallabia</b>rantz. Tarte hau batez ere jaisten da eta nahiko erraza da, konplikazio tekniko handirik gabe.',
    'Una vez en Mallabia cambiamos nuevamente de terreno. Subimos por asfalto para ganar altura en busca de uno de los senderos más interesantes de toda la vuelta. El objetivo es regresar hacia el río que acabamos de dejar atrás, pero esta vez lo haremos por un sendero escondido, técnico y muy juguetón.':
        'Behin Mallabian, berriro lur mota aldatzen dugu. Asfaltotik gora egiten dugu altuera irabazteko, buelta osoko bidezidorrik interesgarrienetako baten bila. Helburua atzean utzi berri dugun ibaira itzultzea da, baina oraingoan bidezidor ezkutu, tekniko eta oso jostagarri batetik egingo dugu.',
    'Para encontrar su entrada es importante seguir bien el track, ya que desde el camino principal pasa bastante desapercibido. Una vez dentro comienza una bajada muy bonita, con bastante más carácter que los caminos anteriores. No es un sendero para bajar despistado: tiene zonas técnicas y está pensado sobre todo para quien disfrute moviendo la bici y buscando un poco más de diversión. Es precisamente uno de esos pequeños caminos escondidos que merece la pena conocer.':
        'Bere sarrera aurkitzeko garrantzitsua da trackari ondo jarraitzea, bide nagusitik nahiko oharkabean pasatzen baita. Behin barruan, jaitsiera oso polita hasten da, aurreko bideek baino izaera askoz gehiago duena. Ez da deskuidatuta jaisteko bidezidorra: zona teknikoak ditu eta bereziki pentsatuta dago bizikleta mugitzeaz gozatzen duenarentzat eta dibertsio pixka bat gehiago bilatzen duenarentzat. Hain zuzen ere, ezagutzea merezi duen bide ezkutu txiki horietako bat da.',
    'Una vez abajo, junto al río, volvemos a coger el mismo camino por el que anteriormente habíamos bajado desde el barrio de Aitzu, pero ahora lo hacemos en sentido contrario. Vamos remontando hasta regresar nuevamente al barrio.':
        'Behin behean, ibaiaren ondoan, lehen Aitzu auzotik jaitsi ginen bide bera hartzen dugu berriro, baina oraingoan alderantzizko norabidean. Gora egiten dugu berriro auzora itzuli arte.',
    'Al llegar a Aitzu, giramos a la izquierda y continuamos por el camino asfaltado hasta salir a la carretera general. Aquí giramos a la derecha y avanzamos por ella solo unos metros. En plena parte alta de la carretera general, junto a un caserío, volvemos a dejar el asfalto para coger una pista que sale a mano derecha.':
        'Aitzura iristean, ezkerrera biratzen dugu eta asfaltozko bidetik jarraitzen dugu errepide nagusira atera arte. Hemen eskuinera biratzen dugu eta metro batzuk baino ez ditugu aurreratzen bertatik. Errepide nagusiaren goiko partean, baserri baten ondoan, asfaltoa berriro uzten dugu eskuinaldera ateratzen den pista bat hartzeko.',
    'A partir de aquí volvemos a meternos en el monte. La intención es enlazar con el camino que pasa por detrás de <b><a href="arietzu.html">Arietzu</a></b>, evitando continuar por la carretera y conociendo otra alternativa por esta zona.':
        'Hemendik aurrera berriro mendian sartzen gara. Asmoa <b><a href="arietzu.html">Arietzu</a></b>ren atzetik doan bidearekin lotzea da, errepidetik jarraitu beharrik gabe eta zona honetako beste alternatiba bat ezagutuz.',
    'Seguimos por este recorrido hasta comenzar la subida hacia <b>Osmagain</b>. Es un tramo bastante asequible y vamos ganando altura poco a poco hasta alcanzar la parte superior.':
        'Ibilbide honetatik jarraitzen dugu <b>Osmagain</b>erako igoera hasi arte. Tarte nahiko eramangarria da eta pixkanaka altuera irabazten goaz, goiko partera iritsi arte.',
    'Desde aquí nos encontramos con el trazado de la <a href="https://7pago.com" target="_blank" rel="noopener noreferrer">7 Pago Mendi Lasterketa</a>, pero nosotros lo recorremos en sentido contrario al de la carrera. Esto nos deja una bajada bastante entretenida por una zona por la que los corredores realizan la subida.':
        'Hemendik aurrera <a href="https://7pago.com" target="_blank" rel="noopener noreferrer">7 Pago Mendi Lasterketa</a>ren ibilbidearekin egiten dugu topo, baina guk lasterketaren kontrako norabidean egiten dugu. Honek jaitsiera nahiko dibertigarria uzten digu, korrikalariek igoera egiten duten zona batetik.',
    'Mucho ojo con esta bajada. El camino está bastante limpio, pero tiene pendiente y algunos puntos técnicos. No llega a ser extremo, aunque sí es un descenso juguetón y de los que se disfrutan más teniendo algo de experiencia sobre la bici.':
        'Kontu handiz jaitsiera honekin. Bidea nahiko garbi dago, baina malda badu eta puntu tekniko batzuk. Ez da muturrekoa izatera iristen, baina bai jaitsiera jostagarria da, bizikletan trebetasun pixka bat izanda gehiago gozatzen direnetakoa.',
    'El descenso nos devuelve nuevamente hacia Zengotita. Como la intención de esta vuelta no es simplemente regresar a Trabakua, sino enseñar diferentes posibilidades y caminos de la zona, todavía alargamos un poco más el recorrido.':
        'Jaitsierak berriro Zengotitarantz eramaten gaitu. Buelta honen asmoa ez denez soilik Trabakuara itzultzea, zonako aukera eta bide desberdinak erakustea baizik, ibilbidea pixka bat gehiago luzatzen dugu oraindik.',
    'Seguimos otro tramo del trazado de la 7 Pago Mendi Lasterketa en sentido contrario, atravesando nuevamente los caminos de la zona antes de realizar el último descenso.':
        '7 Pago Mendi Lasterketaren beste tarte bat jarraitzen dugu alderantzizko norabidean, zonako bideak berriro zeharkatuz azken jaitsiera egin aurretik.',
    'Finalmente bajamos hasta enlazar con la carretera general. A partir de aquí ya no buscamos más complicaciones: nos quedan aproximadamente 2 kilómetros por carretera para regresar a Trabakua y cerrar la vuelta.':
        'Azkenean errepide nagusiarekin lotu arte jaisten dugu. Hemendik aurrera ez dugu konplikazio gehiagorik bilatzen: 2 kilometro inguru geratzen zaizkigu errepidetik Trabakuara itzultzeko eta buelta ixteko.',
    'En conjunto, es una ruta pensada más para descubrir caminos y senderos que para ir simplemente de un punto a otro. Aprovechamos pistas conocidas para enlazar pasos menos utilizados, algunos de ellos bastante escondidos, y conocer diferentes maneras de moverse entre Trabakua, Zengotita, Aitzu, Mallabia, Arietzu y Osmagain.':
        'Oro har, bide eta bidezidorrak ezagutzeko pentsatutako ibilbidea da gehiago, puntu batetik bestera joateko baino. Ezagutzen ditugun pistak aprobetxatzen ditugu gutxiago erabiltzen diren pasabideak lotzeko, batzuk nahiko ezkutuak, eta Trabakua, Zengotita, Aitzu, Mallabia, Arietzu eta Osmagain artean mugitzeko modu desberdinak ezagutzeko.',
    'Hay subidas llevaderas, tramos tranquilos y varias bajadas técnicas y juguetonas que le dan personalidad a la vuelta. Se puede realizar con una BTT convencional, pero para este tipo de recorrido recomendamos especialmente la e-bike, ya que permite moverse con mayor comodidad entre tantos cambios de desnivel y aprovechar mejor todos estos pequeños enlaces y senderos.':
        'Igoera eramangarriak, tarte lasaiak eta hainbat jaitsiera tekniko eta jostagarri daude, bueltari izaera ematen diotenak. BTT konbentzional batekin egin daiteke, baina mota honetako ibilbiderako e-bikea gomendatzen dugu bereziki, desnibel-aldaketa horien artean erosotasun handiagoz mugitzea ahalbidetzen baitu eta lotura eta bidezidor txiki hauek guztiak hobeto aprobetxatzea.',
    'No es una ruta extrema, pero sí conviene tener algo de experiencia sobre la bici, especialmente para disfrutar con seguridad de las bajadas más técnicas. Para quien ya conozca las pistas principales de esta zona, es una buena oportunidad para descubrir varios caminos que normalmente pasan desapercibidos.':
        'Ez da ibilbide muturrekoa, baina komeni da bizikletan trebetasun pixka bat izatea, batez ere jaitsiera teknikoenak seguru gozatzeko. Zona honetako pista nagusiak jada ezagutzen dituenarentzat, aukera ona da normalean oharkabean pasatzen diren hainbat bide ezagutzeko.',
