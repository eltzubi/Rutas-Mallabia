...
TRABAKUA = {
    ...
    'Asuntza. Es un tramo opcional: se puede evitar siguiendo recto, sin desviarse hacia él.':
        'Aldapa horien ostean, jaitsiera tekniko samar bat dator —trebetasun pixka bat '
        'duenarentzat arriskurik gabe—, eta oso gozagarria. Jaitsieraren amaieran berriro '
        ...
        'gero ekiditzea da gezia, zuzen aurrera segi gabe, bidegrutzetik aldendu gabe.',
