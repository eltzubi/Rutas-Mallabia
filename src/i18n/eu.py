...
MARKINABOLIBAR = {
    ...
    '<p>38,47 km y +1.204 m de desnivel en un solo circuito, con superficie de pista y carretera. Hay agua en la fuente de Urregarai, junto al refugio y la bolera, y otra junto al Camino de Santiago antes de llegar a Iruzubieta. A este mismo Urregarai tambi&eacute;n se puede llegar entrando por el otro lado, desde Iturreta al sur: es la ruta <a href="urregarai.html">Iturreta, Markina y Urregarai</a>.</p>':
        '<p>38,47 km eta +1.204 m-ko desnibela zirkuitu bakarrean, pista eta errepide gainekoa. Ura badago Urregaraiko iturrian, aterpearen eta bolatokiaren ondoan, eta beste bat Done Jakue bidean, Iruzubietara iritsi aurretik. Urregarai berera beste aldetik ere iritsi daiteke, Iturretatik hegoaldetik: <a href="urregarai.html">Iturreta, Markina eta Urregarai</a> ibilbidea da.</p>',
