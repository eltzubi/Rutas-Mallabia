...
SARRIMENDI = {
    ...
    'Al llegar a <b>Zengotitagane</b> (km 2,4 &middot; 810 m), dejamos a un lado los e&oacute;licos y nos adentramos de frente en el hayedo. Lo atravesamos hasta llegar a <b><a href="iturrizuri.html">Iturzuri</a></b> (km 3,7 &middot; 809 m), donde encontramos el refugio y la fuente, un buen lugar para coger agua.':
        '<b>Zengotitagane</b>ra iristean (2,4 km &middot; 810 m), haize-sorgailuak alde batera utzi eta pagadian barneratuko gara. Pagadia zeharkatuko dugu <b><a href="iturrizuri.html">Iturzuri</a></b>ra iritsi arte (3,7 km &middot; 809 m), non aterpea eta iturria aurkituko ditugun, ura hartzeko leku egokia.',
    ...
    'Bajamos casi hasta Betzun y, tras un peque&ntilde;o repecho, seguimos descendiendo por pistas y caminos de barrio hasta alcanzar <b>Zengotita</b> (km 16,1 &middot; 411 m). El punto de agua se encuentra en el propio barrio, por lo que podemos aprovechar para coger agua all&iacute; antes de continuar.':
        'Ia Betzunerainoko jaitsiera egingo dugu eta, aldapatxo baten ondoren, pistetatik eta auzo-bideetatik jaisten jarraituko dugu <b>Zengotita</b>ra iritsi arte (16,1 km &middot; 411 m). Ur-puntua auzoan bertan dago; beraz, ura hartzeko aprobetxa dezakegu aurrera jarraitu aurretik.',
    ...
    'Un poco m&aacute;s adelante pasamos por la <b>fuente de Arteta</b> (km 24,3 &middot; 472 m), nuestro &uacute;ltimo punto claro para coger agua antes de afrontar la parte final.':
        'Aurreraxeago, <b>Artetako iturritik</b> pasatuko gara (24,3 km &middot; 472 m), azken ur-puntu argia, azken zatia egin aurretik.',
