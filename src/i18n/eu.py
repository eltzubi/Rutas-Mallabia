...
GEREAOCULTA = {
    ...
    'Ya cerca de <b>Trabakua</b> enlazamos con el camino que sube hacia <b>Zengotitagaina</b>, donde buscamos un sendero muy cuidado, limpio y bonito. Es corto, pero tiene un poco de todo: entretenido, con alg&uacute;n punto t&eacute;cnico y un final intenso que hace que merezca la pena llegar hasta &eacute;l.':
        '<b>Trabakua</b>tik gertu, <b>Zengotitagaina</b>ra igotzen den bidearekin lotzen dugu, eta oso zaindutako, garbi eta polita den bidexka bat bilatzen dugu. Laburra da, baina denetik pixka bat du: entretenigarria, puntu tekniko batzuekin eta amaiera bizi batekin, honaino iristeak merezi duena.',
