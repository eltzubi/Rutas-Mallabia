...
HIRUTXIKIAK = {
    ...
    # body copy
    'La <a href="https://hirutxikiak.com/" target="_blank" rel="noopener noreferrer">Hiru Txikiak Trail</a> es una carrera de monte organizada por el club Korrikazaleak, con salida y meta en Ermua, que sube a tres cumbres muy conocidas de la zona: <b><a href="urko.html">Urko</a></b>, <b><a href="oiz.html">Oiz</a></b> y <b><a href="egoarbitza.html">Egoarbitza</a></b>. Es una carrera dura y exigente &mdash;m&aacute;s de 40 km y m&aacute;s de 2.000 m de desnivel positivo&mdash; en la que, desde casi el principio, toca subir.':
