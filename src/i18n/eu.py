...
OSMA = {
    ...
    'hasta la segunda <b>Ermita de San Juan</b> (km 18,8 &middot; '
    ...
    'una fuente junto a la necr&oacute;polis para llenar cantimploras.':
        ...
        'Elorriorantz jaisteko bidegurutzeraino, Aldape auzotik, bigarren <b>San Juan '
        'ermitaraino</b> bat-batean jaitsi aurretik (18,8 km &middot; '
        '286 m). Kilometro eta '
    ...
    'panor&aacute;mica amplia sobre el Duranguesado y el camino deja el asfalto por sendero y pista de '
    'tierra hasta la primera de una cadena de ermitas: San Lorenzo (km 22,4 &middot; 312 m), San Juan '
    'Bautista de Murgoitio (km 24,3 &middot; 277 m) y San Antonio de Olakueta (km 25,8 &middot; 160 '
    'm), donde se pierde altura de golpe. Gira despu&eacute;s hacia el este para subir hasta la '
    '<b>Ermita de San Miguel de Okango</b> (km 28,4 &middot; 227 m) y baja de nuevo camino de '
    'Zaldibar, pero sin entrar en el pueblo gira para continuar hasta <b>Berriz</b> (km 30,7 '
    '&middot; 187 m), en el valle del Ibaizabal, al pie del Oiz.':
        'Handik gora jarraitzen du Mendraca auzorantz, non paisaia Durangaldeko ikuspegi zabal '
        'batean irekitzen den eta bideak asfaltoa utzi eta bidezidor eta lurrezko pista bihurtzen '
        'den, hainbat ermitaren katearen lehenengoraino: San Lorentzo (22,4 km &middot; 312 m), '
        'Murgoitioko San Juan Bataiatzailea (24,3 km &middot; 277 m) eta Olakuetako San Antonio '
        '(25,8 km &middot; 160 m), non altuera bat-batean galtzen den. Gero ekialderantz '
        'biratzen du <b>Okangoko San Migel ermitaraino</b> igotzeko (28,4 km &middot; 227 m) eta '
        'berriro jaisten da Zaldibar aldera, baina herrira sartu gabe biratu eta '
        '<b>Berrizeraino</b> jarraitzen du (30,7 km &middot; 187 m), Ibaizabal haranean, Oizen '
        'oinean.',
