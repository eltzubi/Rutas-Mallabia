...
AXMAKURANDIKOA = {
    ...
    'Continuamos por esta pista hasta llegar abajo del todo, donde enlazamos con el camino que viene de <b>Andikoa</b> (km 16,0 &middot; 202 m). Garai queda ya muy cerca hacia la derecha, pero nosotros giramos a la izquierda para empezar poco a poco el regreso.':
        'Pista honetatik jarraitzen dugu behealdera iritsi arte, non <b>Andikoa</b>tik datorren bidearekin lotzen garen (16,0 km &middot; 202 m). Garai oso gertu dago eskuinaldera, baina gu ezkerrera biratzen gara itzulerari ekiteko.',
