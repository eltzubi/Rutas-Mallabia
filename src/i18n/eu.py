...
MARKINABOLIBAR = {
    ...
    '<p>38,47 km y +1.204 m de desnivel en un solo circuito, entre pistas de tierra (el tramo de Zeinka a Urregarai) y asfalto de barrio &mdash; sin entrar en ninguna carretera general, solo cruz&aacute;ndolas. La subida final, de Bolibar a Muniozguren (+363 m), es la m&aacute;s dura de la vuelta. Hay agua en la fuente de Urregarai, junto al refugio y la bolera, y otra junto al Camino de Santiago antes de llegar a Iruzubieta. A este mismo Urregarai tambi&eacute;n se puede llegar entrando por el otro lado, desde Iturreta al sur: es la ruta <a href="urregarai.html">Iturreta, Markina y Urregarai</a>.</p>':
        '<p>38,47 km eta +1.204 m-ko desnibela zirkuitu bakarrean, lurrezko pisten (Zeinkatik Urregairako zatia) eta auzoko asfaltoaren artean &mdash; errepide nagusietan sartu gabe, gurutzatu besterik ez. Azken igoera, Bolibartik Muniozgurenerainokoa (+363 m), da buelta osoko gogorrena. Ura badago Urregaraiko iturrian, aterpearen eta bolatokiaren ondoan, eta beste bat Done Jakue bidean, Iruzubietara iritsi aurretik. Urregarai berera beste aldetik ere iritsi daiteke, Iturretatik hegoaldetik: <a href="urregarai.html">Iturreta, Markina eta Urregarai</a> ibilbidea da.</p>',
