...
SANTAEUFEMIA = {
    ...
    '    <p>Si el d&iacute;a est&aacute; despejado, merece la pena quedarse un rato arriba. Las vistas son muy amplias, pr&aacute;cticamente de 360 grados, y desde aqu&iacute; se domina buena parte de <b>Lea-Artibai</b>, la costa y muchas de las monta&ntilde;as del interior.</p>':
        '<p>Aterpetik eskuinera hartuta, pista batean sartzen gara, eta hortik <b><a href="urregarai.html">Urregarai</a></b>ko gainean dagoen Santa Eufemiako ermitaraino igotzen gara. Azken zatia berezia da: kareharrizko haitzak eta 222 mailako harrizko eskailera luzea, ermitaren ondoan amaitzen dena. Leku honek historia handia dauka, eta inguruan oso ezaguna da, batez ere irailean ospatzen den erromeriagatik. Eguna garbi bada, goian gelditzea merezi du. Ikuspegia ia 360 gradukoa da, eta hemendik <b>Lea-Artibai</b>ko zati handi bat, kostaldea eta barnealdeko mendiak ederki ikusten dira.</p>',
