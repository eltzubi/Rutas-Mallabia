...
MARKINABOLIBAR = {
    ...
    'Pasado el monasterio, un poco m&aacute;s adelante encontramos un cruce: a la izquierda sale el camino hacia <a href="sancristobaloiz.html">San Crist&oacute;bal (Oiz)</a>, y nosotros seguimos a la derecha, por el mismo trazado del Camino de Santiago, comenzando a subir hacia el puerto de <b>Gontzagarai</b>. Una vez arriba dejamos atr&aacute;s el recorrido que siguen los peregrinos, cruzamos la carretera general y nos adentramos hacia el barrio de <b>Gerrika</b>, todav&iacute;a en ascenso.':
        'Monasterioa pasata, aurreraxeago bidegurutze bat aurkituko dugu: ezkerretara <a href="sancristobaloiz.html">San Kristobal (Oiz)</a> aldera doan bidea dago, eta guk eskuinetara jarraitzen dugu, Done Jakue bidearen trazadura beretik, <b>Gontzagarai</b> mendaterantz igotzen hasita. Goian, erromesen ibilbidea atzean utzi, errepide nagusia gurutzatu, eta <b>Gerrika</b> auzorantz sartzen gara, oraindik ere gorantz.',
    ...
    'Despu&eacute;s de reponer agua seguimos por el otro lado y comenzamos el descenso. Primero atravesamos una zona de pastizales junto a una granja y, a partir de ah&iacute;, empezamos a perder altura de forma bastante seguida, aunque siempre por buen camino asfaltado.':
        'Ura hartu ondoren, beste aldetik jarraitzen dugu eta jaitsierari ekiten diogu. Lehenik, larre-eremu bat zeharkatzen dugu baserri handi baten ondoan, eta hortik aurrera, altuera galtzen hasten gara nahiko jarraian, nahiz eta beti errepide asfaltatu onetik.',
    ...
    'Llegamos as&iacute; a <b>Bolibar</b> (km 29,38 &middot; 173 m). A la salida del pueblo, el Camino de Santiago contin&uacute;a hacia Zenarruza por una antigua calzada empedrada que asciende directamente hacia el monasterio. Es un tramo bonito y con mucho car&aacute;cter, pero nosotros, al ir en bici, no podemos continuar por ah&iacute;.':
        'Horrela, <b>Bolibar</b>rera iristen gara (29,38 km &middot; 173 m). Herriaren irteeran, Done Jakue bideak Zenarruzarantz jarraitzen du, monasteriorantz zuzenean igotzen den galtzada zahar batetik. Zati polita eta izaera handikoa da, baina guk, bizikletaz goazenez, ezin dugu hortik jarraitu.',
    'En su lugar seguimos por la carretera que sube hacia Zenarruza. Nos queda un &uacute;ltimo repecho antes de alcanzar nuevamente el monasterio y cerrar el bucle en el mismo punto donde lo empezamos.':
        'Horren ordez, Zenarruzarantz igotzen den errepidetik jarraitzen dugu. Azken aldapa bat geratzen zaigu monasteriora iritsi eta begizta ixteko, hasi genuen leku berean.',
    'Desde Zenarruza retomamos el mismo camino de subida hacia Muniozguren y, desde all&iacute;, bajamos de nuevo por Gerea hasta Trabakua, donde cerramos la ruta.':
        'Zenarruzatik Muniozgurenerantz igotzeko bide beretik itzultzen gara, eta handik Gereatik behera Trabakuaraino, ibilbidea ixten dugun lekura.',
}
