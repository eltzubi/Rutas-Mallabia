...
SARRIMENDI = {
    ...
    'Bajamos casi hasta Betzun y, tras un peque&ntilde;o repecho, seguimos descendiendo por pistas y caminos de barrio hasta alcanzar <b>Zengotita</b> (km 15,5 &middot; 411 m). El punto de agua se encuentra en el propio barrio, por lo que podemos aprovechar para coger agua all&iacute; antes de continuar.':
        'Ia Betzunerainoko jaitsiera egingo dugu eta, aldapatxo baten ondoren, pistetatik eta auzo-bideetatik jaisten jarraituko dugu <b>Zengotita</b>ra iritsi arte (15,5 km &middot; 411 m). Ur-puntua auzoan bertan dago; beraz, ura hartzeko aprobetxa dezakegu aurrera jarraitu aurretik.',
