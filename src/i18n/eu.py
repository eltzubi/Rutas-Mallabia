...
MARKINABOLIBAR = {
    ...
    '<p>40,39 km y +1.236 m de desnivel en un solo circuito, con superficie de pista y carretera: la ruta con m&aacute;s desnivel publicada hasta ahora en esta web. El tramo original de Markina, Bolibar, Zenarruza, Zeinka y Urregarai ronda los 22 km, pero para enlazarlo con Trabakua a&ntilde;adimos la subida y bajada real hasta Zenarruza por Muniozguren, ya conocida de la ruta de <a href="sancristobaloiz.html">San Crist&oacute;bal (Oiz)</a>. Hay agua en la fuente de Urregarai, junto al refugio y la bolera, y otra junto al Camino de Santiago antes de llegar a Iruzubieta. Por el otro lado, la ruta <a href="urregarai.html">Iturreta, Markina y Urregarai</a> pasa cerca de la ermita de Santa Eufemia, por la parte de abajo en Urregarai, sin subir hasta ella.</p>':
        '<p>40,39 km eta +1.236 m-ko desnibela zirkuitu bakarrean, pista eta errepide gainekoa: webgune honetan orain arte argitaratutako desnibel handieneko ibilbidea. Markina, Bolibar, Zenarruza, Zeinka eta Urregaraiko jatorrizko zatiak 22 km inguru ditu, baina Trabakuarekin lotzeko Muniozgurenetik Zenarruzarainoko benetako igoera eta jaitsiera gehitu ditugu, <a href="sancristobaloiz.html">San Kristobal (Oiz)</a> ibilbidetik ezaguna. Ura badago Urregaraiko iturrian, aterpearen eta bolatokiaren ondoan, eta beste bat Done Jakue bidean, Iruzubietara iritsi aurretik. Beste aldetik, <a href="urregarai.html">Iturreta, Markina eta Urregarai</a> ibilbideak Santa Eufemiako ermitatik gertu pasatzen da, Urregaraiko beheko aldetik, harainoko igoerarik egin gabe.</p>',
