...
SANTAMANAZARANDIKOA = {
    ...
    '<p>Esta parte de la vuelta es especialmente bonita por las vistas. Frente a nosotros se abre buena parte de los montes del Duranguesado, desde Anboto hasta Mugarra, con el resto de monta&ntilde;as entre medias.</p>':
        '<p>Itzuliaren zati hau bereziki polita da ikuspegiengatik. Gure aurrean Durangaldeko mendien zati handi bat zabaltzen da, Anbototik Mugarraraino, tarteko gainerako mendiekin.</p>',
