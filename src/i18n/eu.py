...
MARKINABOLIBAR = {
    ...
    '<p>40,39 km y +1.236 m de desnivel en un solo circuito, con superficie de pista y carretera: la ruta con m&aacute;s desnivel publicada hasta ahora en esta web. Hay agua en la fuente de Urregarai, junto al refugio y la bolera, y otra junto al Camino de Santiago antes de llegar a Iruzubieta. A este mismo Urregarai tambi&eacute;n se puede llegar entrando por el otro lado, desde Iturreta al sur: es la ruta <a href="urregarai.html">Iturreta, Markina y Urregarai</a>.</p>':
        '<p>40,39 km eta +1.236 m-ko desnibela zirkuitu bakarrean, pista eta errepide gainekoa: webgune honetan orain arte argitaratutako desnibel handieneko ibilbidea. Ura badago Urregaraiko iturrian, aterpearen eta bolatokiaren ondoan, eta beste bat Done Jakue bidean, Iruzubietara iritsi aurretik. Urregarai berera beste aldetik ere iritsi daiteke, Iturretatik hegoaldetik: <a href="urregarai.html">Iturreta, Markina eta Urregarai</a> ibilbidea da.</p>',
