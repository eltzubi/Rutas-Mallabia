...
SARRIMENDI = {
    ...
    'Al llegar a <b>Zengotitagane</b> (km 1,9 &middot; 810 m), dejamos a un lado los e&oacute;licos y nos adentramos de frente en el hayedo. Lo atravesamos hasta llegar a <b><a href="iturrizuri.html">Iturzuri</a></b> (km 3,1 &middot; 809 m), donde encontramos el refugio y la fuente, un buen lugar para coger agua.':
        '<b>Zengotitagane</b>ra iristean (1,9 km &middot; 810 m), haize-sorgailuak alde batera utzi eta pagadian barneratuko gara. Pagadia zeharkatuko dugu <b><a href="iturrizuri.html">Iturzuri</a></b>ra iritsi arte (3,1 km &middot; 809 m), non aterpea eta iturria aurkituko ditugun, ura hartzeko leku egokia.',
    ...
    'A partir de aqu&iacute; comienza uno de los tramos diferentes de la ruta. En vez de avanzar por la parte m&aacute;s alta, recorremos la ladera buscando caminos menos habituales y ganando altura poco a poco. Finalmente volvemos a encontrarnos con la l&iacute;nea de e&oacute;licos, ya muy cerca de la zona de las antenas y de la cumbre del <b>Oiz</b> (km 6,2 &middot; 1.019 m).':
        'Hemendik aurrera, ibilbidearen zati desberdin bat hasten da. Goi-eremutik aurrera egin beharrean, mendi-hegala zeharkatuko dugu, hain ohikoak ez diren bideak bilatuz eta altuera pixkanaka irabaziz. Azkenik, haize-sorgailuen lerroarekin topo egingo dugu berriro, antenen eta <b>Oizko</b> tontorraren oso gertu (6,2 km &middot; 1.019 m).',
    'Desde aqu&iacute; cogemos la pista que discurre junto a los e&oacute;licos y comenzamos a bajar en direcci&oacute;n a Garai. No tenemos que abandonar esta pista hasta llegar a la conocida como <b><a href="potrera.html">curva de la Potrera</a></b> (km 9,8 &middot; 714 m). All&iacute; giramos a la izquierda y entramos en la bajada del mismo nombre, llamada as&iacute; por la peque&ntilde;a potrera para caballos situada junto al camino.':
    ...
    'Cruzamos esa pista de frente y comenzamos la subida hacia <b>Sarrionamendia</b> (km 11,7 &middot; 597 m). Volvemos a ganar altura y, seg&uacute;n ascendemos, se abren buenas vistas sobre los montes y valles de alrededor. Una vez arriba merece la pena disfrutar del paisaje antes de volver a bajar por el mismo camino hasta la fuente situada en la base de Sarrionamendia.':
        'Pista hori aurrez aurre gurutzatu eta <b>Sarrionamendi</b>rantz igotzen hasiko gara (11,7 km &middot; 597 m). Berriro ere altuera irabaziko dugu, eta, igotzen garen heinean, inguruko mendien eta haranen bista ederrak izango ditugu. Goian, paisaiaz gozatzea merezi du, Sarrionamendiko oinarrian dagoen iturriraino berriro jaitsi aurretik.',
    'De nuevo junto a la fuente, en la base de Sarrionamendia, giramos a la derecha y comenzamos a bajar hacia <b>San Crist&oacute;bal Txiki</b> (km 13,0 &middot; 497 m). Sin embargo, poco antes de llegar nos desviamos nuevamente a la izquierda, buscando el camino que nos lleva hacia el caser&iacute;o de <b><a href="betzun.html">Betzun</a></b>, antes de llegar a Zengotita.':
        'Berriro ere iturriaren ondoan, Sarrionamendiko oinarrian, eskuinera biratu eta <b>San Kristobal Txiki</b>rantz jaisten hasiko gara (13,0 km &middot; 497 m). Hala ere, iritsi baino pixka bat lehenago, berriro ezkerrera desbideratuko gara, <b><a href="betzun.html">Betzun</a></b> baserrirako bidea bilatuz, Zengotitara iritsi aurretik.',
    'Bajamos casi hasta Betzun y, tras un peque&ntilde;o repecho, seguimos descendiendo por pistas y caminos de barrio hasta alcanzar <b>Zengotita</b> (km 15,5 &middot; 411 m). El punto de agua se encuentra en el propio barrio, por lo que podemos aprovechar para coger agua all&iacute; antes de continuar. Adem&aacute;s, este es un buen punto para retirarse en caso de cansancio o de alg&uacute;n problema, ya que Trabakua estar&iacute;a a poco m&aacute;s de 2 kil&oacute;metros cogiendo la carretera general.':
        'Ia Betzunerainoko jaitsiera egingo dugu eta, aldapatxo baten ondoren, pistetatik eta auzo-bideetatik jaisten jarraituko dugu <b>Zengotita</b>ra iritsi arte (15,5 km &middot; 411 m). Ur-puntua auzoan bertan dago; beraz, ura hartzeko aprobetxa dezakegu aurrera jarraitu aurretik. Gainera, toki ona da atzera egiteko nekea edo arazoren bat izanez gero, Trabakua errepide nagusitik 2 kilometro pasatxora baitago.',
    ...
    'Una vez alcanzada la cresta giramos a la izquierda y avanzamos buscando al fondo la cruz de <b><a href="arietzu.html">Arietxu</a></b> (km 17,4 &middot; 476 m). Desde all&iacute; comenzamos a descender hacia el barrio de Aitzu, enlazando despu&eacute;s con el camino que nos llevar&aacute; hasta Mallabia.':
        'Gailurrera iritsitakoan, ezkerrera biratu eta <b><a href="arietzu.html">Arietzu</a></b>ko gurutzea bilatuz aurrera egingo dugu (17,4 km &middot; 476 m). Handik, Aitzu auzorantz jaisten hasiko gara, ondoren Mallabiaraino eramango gaituen bidearekin lotuz.',
    'Atravesamos <b>Mallabia</b> (km 19,7 &middot; 254 m) en direcci&oacute;n a la parte alta del pueblo, hacia San Pedro, sin olvidarnos de coger agua en la plaza del pueblo antes de continuar con la segunda parte de la ruta.':
        '<b>Mallabia</b> zeharkatuko dugu (19,7 km &middot; 254 m) herriaren goialderantz, San Pedro aldera, herriko plazan ura hartzea ahaztu gabe ibilbidearen bigarren zatia jarraitu aurretik.',
    ...
    'A partir de aqu&iacute; volvemos a alejarnos del pol&iacute;gono y comenzamos a subir hacia <a href="arteta.html">Arteta</a>. El ascenso es progresivo hasta alcanzar una pista de piedra m&aacute;s arreglada, ya en la parte baja de Arteta.':
        'Hemendik aurrera, industrialdetik urrunduko gara berriro eta <a href="arteta.html">Arteta</a>rantz igotzen hasiko gara. Igoera progresiboa da, Artetako behealdean dagoen harrizko pista txukunago bat iritsi arte.',
    'Giramos a la izquierda y continuamos por ella. Poco despu&eacute;s abandonamos nuevamente la pista y nos metemos en el monte para buscar un atajo que nos permite ir ganando altura hacia Mendibil.':
        'Ezkerrera biratu eta pistatik jarraituko dugu. Handik gutxira, pista utzi eta mendian sartuko gara berriro, Mendibilerantz altuera irabazteko aukera emango digun lasterbide bat bilatzeko.',
    'Un poco m&aacute;s adelante pasamos por la <b>fuente de Arteta</b> (km 23,8 &middot; 472 m), nuestro &uacute;ltimo punto claro para coger agua antes de afrontar la parte final.':
        'Aurreraxeago, <b>Artetako iturritik</b> pasatuko gara (23,8 km &middot; 472 m), azken ur-puntu argia, azken zatia egin aurretik.',
    'La subida termina llev&aacute;ndonos hasta la cumbre de <b><a href="mendibil.html">Mendibil</a></b> (km 25,4 &middot; 611 m), donde podemos disfrutar de algunas de las &uacute;ltimas buenas vistas de la jornada. Despu&eacute;s de tantos kil&oacute;metros y desnivel acumulado, es un buen punto para echar la vista atr&aacute;s y ver parte del terreno que hemos ido recorriendo.':
        'Igoerak <b><a href="mendibil.html">Mendibil</a></b>eko tontorreraino eramango gaitu (25,4 km &middot; 611 m), non eguneko azken bista ederretako batzuez gozatu ahal izango dugun. Hainbeste kilometro eta desnibel metatu ondoren, atzera begiratu eta zeharkatu dugun lurraldearen zati bat ikusteko puntu egokia da.',
