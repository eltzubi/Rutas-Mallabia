...
SANTAMANAZARANDIKOA = {
    ...
    '<p>Aqu&iacute; comienza una de las partes m&aacute;s interesantes de la ruta. Vamos subiendo hacia <b>Santama&ntilde;azar</b>. Al principio la pista se sube bastante bien, especialmente con e-bike, pero m&aacute;s arriba el terreno cambia y aparecen zonas de piedra, placas m&aacute;s lisas y puntos de tierra dura. Con algo de t&eacute;cnica sigue siendo ciclable, aunque puede tocar echar pie a tierra durante unos metros.</p>':
