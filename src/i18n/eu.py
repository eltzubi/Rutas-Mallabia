...
SARRIMENDI = {
    ...
    'En Zengotita tenemos otra fuente. Adem&aacute;s, es un buen punto para abandonar la ruta si vamos cansados o surge alg&uacute;n problema: desde aqu&iacute; podemos regresar a Trabakua por la carretera general en poco m&aacute;s de 2 kil&oacute;metros.':
        'Zengotitan beste iturri bat dugu. Gainera, nekatuta bagaude edo arazoren bat sortzen bada, ibilbidea bertan behera uzteko puntu egokia da: hemendik Trabakuara itzul gaitezke errepide nagusitik 2 kilometro baino gutxiagoan.',
