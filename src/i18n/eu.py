...
URREGARAI = {
    ...
    'al camino de piedra que est&aacute; junto a un caser&iacute;o, y giramos a la izquierda hacia '
    ...
    'mismas marcas, con buenas vistas hacia el pueblo y varios caser&iacute;os de Iturreta.':
        ...
        'pikoarekin, harrizko bidera iritsi arte, baserri baten ondoan dagoena, eta ezkerrera jotzen '
