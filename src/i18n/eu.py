...
COMMON = {
    ...
    '<h3 class="route-card-name">Cascada de Gerea</h3>':
        '<h3 class="route-card-name">Gereako ur-jauzia</h3>',
    ...
    '<h3 class="route-card-name">Trabakua Mendibil</h3>':
        '<h3 class="route-card-name">Trabakua Mendibil</h3>',
    '<h3 class="route-card-name">Trabakua, Mendibil, Olamendi y Arteta</h3>':
        '<h3 class="route-card-name">Trabakua, Mendibil, Olamendi eta Arteta</h3>',
    '<h3 class="route-card-name">Trabakua, Urko, Kalamua, Barinaga, Iturreta y Mendibil</h3>':
        '<h3 class="route-card-name">Trabakua, Urko, Kalamua, Barinaga, Iturreta eta Mendibil</h3>',
    '<h3 class="route-card-name">Trabakua, Longa, Muniozguren</h3>':
        '<h3 class="route-card-name">Trabakua, Longa, Muniozguren</h3>',
    '<h3 class="route-card-name">Trabakua, Barinaga, Iturreta, Bolibar, Zenarruza, Oiz y Zengotitagane</h3>':
        '<h3 class="route-card-name">Trabakua, Barinaga, Iturreta, Bolibar, Zenarruza, Oiz eta Zengotitagane</h3>',
    '<h3 class="route-card-name">7 Pago Mendi Lasterketa 25km</h3>':
        '<h3 class="route-card-name">7 Pago Mendi Lasterketa 25km</h3>',
    '<h3 class="route-card-name">7 Pago Mendi Lasterketa 16K</h3>':
        '<h3 class="route-card-name">7 Pago Mendi Lasterketa 16K</h3>',
    '<h3 class="route-card-name">Asuntza y Mundioko Koba</h3>':
        '<h3 class="route-card-name">Asuntza eta Mundioko Koba</h3>',
    '<h3 class="route-card-name">Trabakua, Iturreta e Iruzubieta</h3>':
    ...
    '<h3 class="route-card-name">Urko, Kalamua, San Migel y Mendibil</h3>':
        '<h3 class="route-card-name">Urko, Kalamua, San Migel eta Mendibil</h3>',
    '<h3 class="route-card-name">Trabakua, Zengotitagane y Maguna</h3>':
...
HOME = {
    ...
    'alt="Pista junto a los aerogeneradores del parque e&oacute;lico, con niebla cubriendo la cresta"':
        'alt="Pista eolikoen ondoan, lainoak gailurra estaltzen duela"',
    'alt="V&eacute;rtice geod&eacute;sico en la cumbre del Urko, con nubes bajas y las monta&ntilde;as del entorno al fondo"':
        'alt="Urkoko gailurreko bertize geodesikoa, hodei baxuekin eta inguruko mendiak atzealdean"',
    'alt="Vista del valle desde la ruta, con caser&iacute;os, un prado con caballos y una pista serpenteando entre los montes"':
        'alt="Haranaren ikuspegia ibilbidetik, baserriekin, zaldiak dituen larre batekin eta mendien artean bihurgunez betetako pista batekin"',
    ...
    'alt="Vistas hacia el Anboto y el Alluitz, con Durango al fondo, desde lo alto de la ruta de Zengotitagane"':
        'alt="Anboto eta Alluitzerako ikuspegiak, Durango atzealdean, Zengotitaganeko ibilbidearen goialdetik"',
    ...
    'alt="La cascada escalonada de Gerea, con el agua bajando entre las rocas"':
        'alt="Gereako ur-jauzi mailakatua, ura harrien artetik jaisten"',
...
OSMA = {
    ...
    'Zengotita': 'Zengotita',
    'Fuente de Goierri': 'Goierriko iturria',
    'Presa de Aixola': 'Aixolako presa',
    'Elgeta': 'Elgeta',
    'Aldape auzoa': 'Aldape auzoa',
    'Argi&ntilde;eta': 'Argi&ntilde;eta',
    'Ermita de San Lorenzo': 'San Lorentzo ermita',
    'Berriz': 'Berriz',
...
GEREA = {
    ...
    '<title>Cascada · 2,95 km · 686 m</title>':
        '<title>Ur-jauzia · 2,95 km · 686 m</title>',
    'download="Cascada de Gerea.gpx"': 'download="Gereako ur-jauzia.gpx"',
    'download="Cascada de Gerea.kml"': 'download="Gereako ur-jauzia.kml"',
    '<span class="num">2</span>Cascada</span>':
        '<span class="num">2</span>Ur-jauzia</span>',
    '<h1>Cascada<br><em>de Gerea</em></h1>':
        '<h1>Gereako<br><em>ur-jauzia</em></h1>',
    ...
    'alt="Foto ampliada del recorrido de la Cascada de Gerea"':
        'alt="Gereako ur-jauzia ibilbidearen argazki handitua"',
    ...
    'alt="La cascada en otoño, con el agua cayendo entre musgo y rocas"':
        'alt="Ur-jauzia udazkenean, ura goroldio eta harrien artetik erortzen"',
    ...
    'alt="La cascada en diciembre, con el agua cayendo con fuerza entre las rocas"':
        'alt="Ur-jauzia abenduan, ura indarrez harrien artetik erortzen"',
    ...
    'del año.':
        ...
        'geldialdia dator: <b>ur-jauzia</b>, harri eta goroldio artean mailaka jaisten dena. '
        'Neguan emaria ikaragarria da; udan asko jaisten da eta ur gutxirekin eta '
...
MAGUNA = {
    ...
    'Atravesamos Maguna y continuamos por carretera hasta encontrarnos con una curva cerrada, donde coincide con la otra ruta a <b><a href="garaimaguna.html">Maguna</a></b>: es el mismo tramo de pista que sale a mano izquierda, abandonando el asfalto. Comienza otra subida larga, que nos llevar&aacute; de nuevo hacia la zona de la carretera que asciende desde Garai hacia Oiz y Zengotitagane, aunque bastante m&aacute;s abajo que por donde hemos pasado anteriormente.':
        'Maguna zeharkatu eta errepidez jarraitzen dugu bihurgune itxi batera iritsi arte, non <b><a href="garaimaguna.html">Maguna</a></b>rako beste ibilbidearekin bat egiten duen: ezkerretik ateratzen den pista bera da, asfaltoa utzita. Beste igoera luze bat hasten da, Garaitik Oiz eta Zengotitaganera igotzen den errepidearen ingurura berriro eramango gaituena, nahiz eta aurretik igaro garen lekutik dezente beherago egon.',
...
PAGO7 = {
    ...
    '<title>Cascada de Gerea &middot; 9,7 km &middot; 689 m</title>':
        '<title>Gereako ur-jauzia &middot; 9,7 km &middot; 689 m</title>',
    ...
    '<span class="elev-legend-item"><span class="num">6</span>Arietzu</span>':
        '<span class="elev-legend-item"><span class="num">1</span>Zengotita</span> '
        '<span class="elev-legend-item"><span class="num">2</span>Gereako ur-jauzia</span> '
        '<span class="elev-legend-item"><span class="num">3</span>Oiz</span> '
    ...
    'alt="Cascada de Gerea, con el agua cayendo entre las rocas del bosque"':
        'alt="Gereako ur-jauzia, ura basoko harrien artetik erortzen"',
    ...
    'Despu&eacute;s de Zengotitagane toca bajar, y bastante. Al principio se puede correr bien, pero seg&uacute;n vamos perdiendo altura la bajada se vuelve m&aacute;s t&eacute;cnica y hay que estar atentos. Abajo cambia de nuevo el terreno y comenzamos a subir de forma m&aacute;s suave hacia la <a href="gerea.html">Cascada de Gerea</a>.':
        'Zengotitagane pasatu ondoren jaitsiera gogorra dator, eta ez da motza. Hasieran ondo korrika egin daiteke, baina behera egin ahala gero eta teknikoagoa bihurtzen da eta adi ibili behar da. Behean, lurra berriro aldatzen da eta igoera lasaiago bati ekiten diogu <a href="gerea.html">Gereako ur-jauzia</a>ren aldera.',
...
BARINAGA = {
    ...
    'Alcanzamos la cima de <b>Kalamua</b> (km 12,4 &middot; 765 m), donde encontramos una torreta y muy buenas vistas hacia las monta&ntilde;as de alrededor. Aqu&iacute; dejamos a un lado la bajada hacia <a href="kalamua.html">San Miguel</a>, que queda hacia el este, y giramos a la izquierda para continuar por una bonita loma, abierta y con grandes vistas.':
        '<b>Kalamua</b> (12,4 km &middot; 765 m) gailurrera iristen gara. Bertan dorretxo bat dago, eta inguruko mendietara bista ederrak zabaltzen dira. Hemen, ekialderantz <a href="kalamua.html">San Migel</a>era jaisten den bidea alde batera utzi, ezkerrera egin eta gandor polit batetik jarraitzen dugu, ikuspegi zabalekin.',
    ...
    'Aqu&iacute; comienza la subida por cemento hasta <a href="iturreta.html"><b>Iturreta</b></a> (km 21,3 &middot; 354 m) &mdash;unos 3,3 km y +205 m&mdash;. Una vez arriba, continuamos por una pista de piedra durante varios kil&oacute;metros, un tramo que viene bien para recuperar piernas antes de afrontar la siguiente subida. No es larga, pero s&iacute; intensa, y asciende por pista de tierra hasta la base de <a href="mendibil.html"><b>Mendibil</b></a>.':
        'Hemendik porlanezko bidetik hasten da <a href="iturreta.html"><b>Iturreta</b>rako</a> (21,3 km &middot; 354 m) igoera &mdash;3,3 km eta +205 m inguru&mdash;. Behin goian, harrizko pista batetik jarraitzen dugu hainbat kilometroz. Hurrengo igoeraren aurretik hankak zertxobait lasaitzeko tarte ona da. Hurrengo igoera ez da luzea, baina bai gogorra: lurrezko pistatik <a href="mendibil.html"><b>Mendibil</b>en</a> magalera igotzen gara.',

    'Llegamos a un cruce con un cartel que indica, entre otros destinos, Markina &mdash;el mismo cruce de la ruta de <a href="urregarai.html">Iturreta, Markina y Urregarai</a>, aqu&iacute; en sentido contrario&mdash;. Mendibil lo tenemos ah&iacute; mismo, a nuestra izquierda. Cogemos el camino, que a partir de aqu&iacute; tiene m&aacute;s de sendero que de pista, y seguimos el track para rodear la monta&ntilde;a y acceder a Mendibil por su parte trasera hasta alcanzar la cima.':
        'Besteak beste Markinarako norabidea adierazten duen seinale batera iristen gara &mdash;<a href="urregarai.html">Iturreta, Markina eta Urregarai</a> ibilbideko bidegurutze bera, hemen alderantziz&mdash;. Mendibil hortxe bertan daukagu, gure ezkerrean. Bidea hartzen dugu &mdash;hemendik aurrera pista baino gehiago bidezidorra da&mdash; eta trackari jarraituz Mendibil inguratu eta atzealdetik igotzen gara gailurrera.',
...
MUNIOZGUREN = {
    ...
    'Seguimos por el camino de cemento, subiendo suavemente al principio, mientras vamos dejando atr&aacute;s alg&uacute;n caser&iacute;o disperso entre las campas. Poco a poco ganamos altura y, en el &uacute;ltimo kil&oacute;metro, la pendiente se hace m&aacute;s pronunciada hasta alcanzar <b>Muniozguren</b> (km 5,5 &middot; 546 m), el punto m&aacute;s alto de la ruta.':
        'Porlanezko bidetik jarraituko dugu, hasieran aldapa leunean, zelaien artean sakabanatutako baserriren bat atzean utziz. Pixkanaka altuera hartzen joango gara eta, azken kilometroan, aldapa gogortu egiten da <b>Muniozguren</b> baserrira (5,5 km &middot; 546 m) iritsi arte, ibilbide honetan altuen dagoen baserria.',
...
EXIGENTE = {
    ...
    'Esta ruta enlaza varios tramos de recorridos ya publicados en la web para formar una vuelta larga, variada y muy entretenida.':
        'Ibilbide honek webgunean dagoeneko argitaratutako hainbat ibilbideren zatiak lotzen ditu, buelta luze, askotariko eta oso entretenigarria osatuz.',

    'Salimos desde <b>Trabakua</b> y, tras poco m&aacute;s de un kil&oacute;metro por asfalto, nos metemos de lleno en caminos de cemento, piedra y tierra. Nada m&aacute;s empezar aparece uno de los repechos m&aacute;s duros del recorrido, aunque apenas dura 300 metros. Despu&eacute;s llega una bonita bajada por tierra que nos lleva entre caser&iacute;os hasta el fondo del valle, muy cerca de <b><a href="barinaga.html">Barinaga</a></b>, sin llegar hasta all&iacute;.':
        '<b>Trabakua</b>tik abiatuko gara eta, asfaltotik kilometro bat pasatxo egin ondoren, zementuzko, harrizko eta lurrezko bideetan sartuko gara bete-betean. Hasi bezain laster ibilbideko aldaparik gogorrenetako bat aurkituko dugu, nahiz eta 300 metro ingurukoa baino ez izan. Ondoren, lurrezko bidetik beherakada polita dator, baserrien artean haranaren hondoraino eramango gaituena, <b><a href="barinaga.html">Barinaga</a></b>tik oso gertu, baina bertara iritsi gabe.',
...
POTRERA = {
    ...
    'En el <b>kil&oacute;metro 7,3</b> la pista llega a una curva cerrada que gira a la derecha. Si en vez de tomarla segu&iacute;ramos de frente, hacia la izquierda, podr&iacute;amos bajar hacia <b>Longa</b> y volver a Trabakua por el recorrido de <a href="muniozguren.html">Trabakua, Longa y Muniozguren</a>. Nosotros continuamos por la pista principal, girando a la derecha, en direcci&oacute;n al <b>Oiz</b>.':
        '<b>7,3. kilometro</b>an pista bihurgune itxi batera iristen da, eskuinera biratzen duena. Hura hartu beharrean zuzen jarraituko bagenu, ezkerretara, <b>Longa</b>ra jaitsi eta Trabakuara itzul gintezke, <a href="muniozguren.html">Trabakua, Longa eta Muniozguren</a> ibilbideari jarraituz. Guk, ordea, pista nagusitik segituko dugu, eskuinera biratuz, <b>Oiz</b>erantz.',
    ...
    'Aqu&iacute; no hay camino: subimos la campa campo a trav&eacute;s hasta alcanzar la parte alta, donde cruzamos un vallado y accedemos a la pista de los aerogeneradores. Ah&iacute; giramos a la izquierda y comenzamos a bajar.':
        'Hemen ez dago biderik: landan zehar gora egingo dugu goiko aldera iritsi arte. Bertan, hesi bat zeharkatu eta eolikoen pistara aterako gara. Ezkerretara hartu eta jaisten hasiko gara.',
...
AIXOLA = {
    ...
    'download="Trabakua, Goierri, Aixola y Eitzaga.kml"':
        'download="Trabakua, Goierri, Aixola eta Eitzaga.kml"',

    # --- relato ---
    'Salimos de <b>Trabakua</b> en direcci&oacute;n a <b>Zengotita</b> y, tras aproximadamente 2 kil&oacute;metros, llegamos a la zona de la ermita. Junto a ella cogemos la pista por la que discurre la GR, que seguiremos en direcci&oacute;n a <b>Goierri</b>. En este primer tramo pasamos junto a la ermita de Goierri, la de <b>Santa Marina</b>, y una fuente de agua, un buen punto para llenar los bidones antes de continuar.':
        '<b>Trabakua</b>tik abiatuko gara <b>Zengotita</b> aldera eta, 2 kilometro inguru egin ondoren, ermita ingurura iritsiko gara. Bertan GRaren bidetik jarraituko dugu, <b>Goierri</b> aldera. Lehen zati honetan Goierriko ermitaren ondotik pasatuko gara, <b>Santa Marina</b>ko baseliza, eta bertan ur-iturria ere badago, bidoiak betetzeko toki aproposa.',
    ...
    'Poco antes de llegar al embalse encontramos otra fuente a nuestra derecha, con el agua saliendo directamente de la pared de la monta&ntilde;a. Seguimos bajando hasta alcanzar la presa y cruzamos por encima del muro hasta el otro lado.':
        'Urtegira iritsi baino pixka bat lehenago beste iturri bat aurkituko dugu eskuinean, ura mendiko hormatik zuzenean ateratzen dela. Beherantz jarraituko dugu presara iritsi arte, eta presaren gainetik beste aldera gurutzatuko gara.',
    'Nada m&aacute;s terminar de cruzarlo giramos a la derecha y cogemos un camino de cemento que arranca con bastante pendiente. Desde aqu&iacute; iniciamos un bonito descenso hacia el barrio de <b>Eitzaga</b>, acompa&ntilde;ados durante buena parte del recorrido por el r&iacute;o y un entorno muy agradable.':
        'Presa gurutzatu bezain laster eskuinera egingo dugu eta malda handiarekin hasten den porlanezko bidea hartuko dugu. Hemendik <b>Eitzaga</b> auzorantz jaitsiera polit bati ekingo diogu, tarte handi batean ibaiaren ingurutik.',
    'Tras pasar por un t&uacute;nel bajo la autopista llegamos al barrio. Giramos a la izquierda y comenzamos de nuevo a ganar altura hacia la zona de Goierri. Una vez arriba volvemos a girar a la izquierda y comenzamos el descenso hacia <b>Zaldibar</b>.':
        'Autopista azpitik doan tunela igaro ondoren Eitzaga auzora iritsiko gara. Bertan ezkerrera egingo dugu eta berriro gorantz hasiko gara, Goierri aldera. Goiko aldera iristean berriz ezkerrera egin eta <b>Zaldibar</b>rerako jaitsiera hasiko dugu.',
    'Atravesamos Zaldibar y nos dirigimos hacia el barrio situado cerca de la estaci&oacute;n. Desde all&iacute; comenzamos a subir hacia la ermita de <b>San Miguel</b>, que queda ya en Berriz, en el barrio de <b>Okango</b>, y continuamos despu&eacute;s por un agradable camino de cemento entre caser&iacute;os, pastos y ganado.':
        'Zaldibar zeharkatu eta geltoki inguruko auzorantz joko dugu. Handik <b>San Migel</b> ermitarantz igotzen hasiko gara; baseliza hori Berrizen dago jada, <b>Okango</b> auzoan. Ondoren, porlanezko bide atsegin batetik jarraituko dugu, baserri, zelai eta abere artean.',
    'Seguimos durante unos kil&oacute;metros por esta pista hasta abandonarla con un giro a la derecha para adentrarnos de nuevo en el monte. Entramos ahora en un camino mucho menos transitado, cruzamos un peque&ntilde;o riachuelo y continuamos por una zona especialmente bonita y tranquila hasta llegar al barrio de <b>Olabe</b>. Es uno de esos tramos que merece la pena incluir simplemente por salirse de los recorridos habituales y conocer un rinc&oacute;n diferente.':
        'Kilometro batzuk egin ondoren pista utzi eta eskuinera egingo dugu, berriro mendiko bide batean sartzeko. Bide hau askoz gutxiago erabiltzen da. Errekatxo bat gurutzatu eta inguru lasai eta polit batetik jarraituko dugu <b>Olabe</b> auzora iritsi arte. Ohiko bideetatik pixka bat aldendu eta beste leku batzuk ezagutzeko merezi duen tarte horietako bat da.',
    'Desde Olabe continuamos unos metros y volvemos a girar a la derecha para afrontar una nueva subida por un antiguo sendero, esta vez en direcci&oacute;n a la zona del cementerio de <b>Berriz</b>. Vamos ganando altura poco a poco hasta alcanzar la parte alta, desde donde un peque&ntilde;o descenso nos deja pr&aacute;cticamente junto al cementerio.':
        'Olaben metro batzuk egin ondoren berriro eskuinera egingo dugu eta beste igoera bati ekingo diogu, bide zahar batetik, <b>Berriz</b>ko hilerriaren aldera. Pixkanaka altuera hartuko dugu goiko aldera iritsi arte, eta handik jaitsiera labur batek ia hilerriaren ondora eramango gaitu.',
    'Salimos de nuevo a la carretera, junto a la iglesia de la parte alta de Berriz, y continuamos en direcci&oacute;n a la autov&iacute;a. El tramo por el arc&eacute;n es corto y enseguida lo abandonamos para coger la carretera vieja que sube hacia el barrio de Zengotita.':
        'Berriro errepidera irtengo gara, Berrizko goialdeko elizaren inguruan, eta autobidearen norabidean jarraituko dugu. Errepide nagusiko bazterbidetik egin beharreko zatia laburra da; handik gutxira utzi eta Zengotita auzora igotzen den errepide zaharra hartuko dugu.',
    'A partir de aqu&iacute; empezamos a cerrar el c&iacute;rculo y volvemos a encontrarnos con el recorrido por el que hab&iacute;amos pasado al comienzo de la ruta. Ya solo quedan unos 2 kil&oacute;metros para regresar a Trabakua, donde damos por terminado el recorrido.':
...
INTXORTA = {
    ...
    'Un poco m&aacute;s adelante llegamos a la central el&eacute;ctrica. Aqu&iacute; cogemos el camino del medio, el que va en ascenso, y unos metros m&aacute;s adelante nos desviamos a la derecha para comenzar la subida hacia <b>Santama&ntilde;azar</b>.':
        'Aurrerago zentral elektrikora iritsiko gara. Hemen erdiko bidea hartuko dugu, gorantz doana, eta metro batzuk aurrerago eskuinera joko dugu, <b>Santama&ntilde;azar</b>rerako igoerari ekiteko.',
    ...
    'Funciona bien como salida larga de <b>trail running</b> o como jornada completa de monta&ntilde;a a pie. Hay tres fuentes repartidas por el recorrido &mdash; a la entrada de Zengotita, junto a la ermita de Goierri y en la ermita de San Salvador &mdash;, lo que permite salir sin cargar de m&aacute;s.':
        'Ibilbidea <b>trail running</b> irteera luze moduan, baita egun osoko mendi-ibilaldi moduan ere, oso ondo moldatzen da. Bidean hiru iturri daude &mdash; Zengotitako sarreran, Goierriko ermitaren ondoan eta San Salbador ermitan &mdash;, eta horri esker beharrezkoa baino gehiago kargatu gabe atera daiteke.',
}
...
ARTETAASUNTZA = {
    ...
    'Salimos desde <b>Trabakua</b> por el camino habitual hacia <b>Asuntza</b>. Durante los primeros kil&oacute;metros avanzamos por caminos conocidos hasta llegar al cruce de <b>Arteta</b>. Es aqu&iacute; donde realmente comienza la parte m&aacute;s especial de esta ruta.':
        'Trabakutik abiatuko gara, ohiko ibilbidea jarraituz Asuntza aldera. Lehen kilometro hauetan, ezagutzen ditugun bideetatik aurrera egingo dugu, Artetako bidegurutzera iritsi arte. Hemen hasten da benetan ibilbide hau, eta hemendik aurrera ingurua esploratzen hasiko gara.',
...
TRABAKUAMALLABIA = {
    ...
    'alt="Foto ampliada del recorrido de Trabakua, Zengotita, Aitzu, Mallabia y Osmagain"':
        'alt="Trabakua, Zengotita, Aitzu, Mallabia eta Osmagaingo ibilbidearen argazki handitua"',
    '<span class="elev-legend-item"><span class="num">4</span>Bajada del sendero</span>':
        '<span class="elev-legend-item"><span class="num">4</span>Bidezidorreko jaitsiera</span>',
    'Bajada del sendero':
    ...
    'Salimos de <b>Trabakua</b> en dirección a <b>Zengotitagane</b>, inicialmente hacia el norte. Empezamos a ganar altura por pista y, en lugar de tomar el desvío habitual de la derecha, continuamos de frente. La pista se vuelve algo más rota y trialera, aunque se puede subir sin demasiados problemas.':
    ...
    'A partir de aquí comenzamos el descenso hacia el barrio de <b>Zengotita</b>. Vamos enlazando caminos hasta coger el que baja directamente al barrio. Justo a la entrada encontramos una fuente de agua a mano derecha, un buen punto para parar y rellenar los bidones.':
        'Hemendik <b>Zengotita</b> auzorantz jaisten hasten gara. Bide batzuk lotu ondoren, auzora zuzenean jaisten den bidea hartzen dugu. Zengotitako sarreran, eskuinean, ur-iturria aurkituko dugu; aukera ona da bertan gelditu eta bidoiak betetzeko.',
    'Atravesamos Zengotita y continuamos bajando hasta la zona de la ermita, donde enlazamos con la GR. La seguimos pasando por <b>Aitzu</b> y continuamos en dirección a <b>Mallabia</b>. Este tramo es principalmente descendente y bastante sencillo, sin grandes complicaciones técnicas.':
        'Zengotita zeharkatu eta beherantz jarraitzen dugu ermitaren ingurura arte. Han GRarekin bat egiten dugu eta <b>Aitzu</b> auzotik pasatuz <b>Mallabia</b> aldera jarraitzen dugu. Tarte hau ia dena beherantz da eta ez dauka zailtasun tekniko handirik.',
    'Una vez en Mallabia cambiamos nuevamente de terreno. Subimos por asfalto para ganar altura en busca de uno de los senderos más interesantes de toda la vuelta. El objetivo es regresar hacia el río que acabamos de dejar atrás, pero esta vez lo haremos por un sendero escondido, técnico y muy juguetón.':
        'Mallabiara iristean berriro gora egitea tokatzen da. Asfaltotik altuera hartzen dugu, ibilbideko bidezidor interesgarrienetako baten bila. Helburua lehenago pasatu dugun ibaira berriro jaistea da, baina oraingoan nahiko ezkutuan dagoen bidezidor tekniko eta jostagarri batetik.',
    'Para encontrar su entrada es importante seguir bien el track, ya que desde el camino principal pasa bastante desapercibido. Una vez dentro comienza una bajada muy bonita, con bastante más carácter que los caminos anteriores. No es un sendero para bajar despistado: tiene zonas técnicas y está pensado sobre todo para quien disfrute moviendo la bici y buscando un poco más de diversión. Es precisamente uno de esos pequeños caminos escondidos que merece la pena conocer.':
        'Sarrera ez da oso nabarmena, beraz komeni da trackari adi jarraitzea. Behin bidezidorrean sartuta, jaitsiera polita eta entretenigarria hasten da. Baditu tarte teknikoak eta ez da despistatuta jaisteko bidea, baina bizikletarekin jolastea gustuko duenarentzat oso dibertigarria da. Inguruan ezkutuan geratzen diren eta ezagutzea merezi duten bide horietako bat da.',
    'Una vez abajo, junto al río, volvemos a coger el mismo camino por el que anteriormente habíamos bajado desde el barrio de Aitzu, pero ahora lo hacemos en sentido contrario. Vamos remontando hasta regresar nuevamente al barrio.':
        'Ibaira iristean, lehenago Aitzutik jaisteko erabili dugun bide bera hartzen dugu berriro, baina oraingoan kontrako noranzkoan. Bidea gora eginez Aitzura itzultzen gara.',
    'Al llegar a Aitzu, giramos a la izquierda y continuamos por el camino asfaltado hasta salir a la carretera general. Aquí giramos a la derecha y avanzamos por ella solo unos metros. En plena parte alta de la carretera general, junto a un caserío, volvemos a dejar el asfalto para coger una pista que sale a mano derecha.':
        'Aitzura iristean ezkerrera biratu eta asfaltatutako auzo-bidetik jarraitzen dugu errepide nagusira irten arte. Han eskuinera biratu eta metro gutxi batzuk egiten ditugu errepidetik. Errepide nagusiaren goiko aldean, baserri baten ondoan, asfaltoa utzi eta eskuinera ateratzen den pista batean sartzen gara.',
    'A partir de aquí volvemos a meternos en el monte. La intención es enlazar con el camino que pasa por detrás de <b><a href="arietzu.html">Arietzu</a></b>, evitando continuar por la carretera y conociendo otra alternativa por esta zona.':
        'Berriro mendian sartuta, <b><a href="arietzu.html">Arietzu</a></b>ren atzetik doan bidea hartzen dugu. Horrela errepidea saihestu eta inguru honetatik pasatzeko beste aukera bat ezagutuko dugu.',
    'Seguimos por este recorrido hasta comenzar la subida hacia <b>Osmagain</b>. Es un tramo bastante asequible y vamos ganando altura poco a poco hasta alcanzar la parte superior.':
        'Bide horretatik jarraituz <b>Osmagain</b>erako igoerarekin lotzen dugu. Igoera nahiko eramangarria da eta pixkanaka altuera irabazten joango gara.',
    'Desde aquí nos encontramos con el trazado de la <a href="https://7pago.com" target="_blank" rel="noopener noreferrer">7 Pago Mendi Lasterketa</a>, pero nosotros lo recorremos en sentido contrario al de la carrera. Esto nos deja una bajada bastante entretenida por una zona por la que los corredores realizan la subida.':
        'Goiko aldean <a href="https://7pago.com" target="_blank" rel="noopener noreferrer">7 Pago Mendi Lasterketa</a>ren ibilbidearekin bat egingo dugu, baina guk lasterketaren kontrako noranzkoan egingo dugu. Horrek esan nahi du korrikalariek igotzen duten zatia guk beherantz egingo dugula.',
    'Mucho ojo con esta bajada. El camino está bastante limpio, pero tiene pendiente y algunos puntos técnicos. No llega a ser extremo, aunque sí es un descenso juguetón y de los que se disfrutan más teniendo algo de experiencia sobre la bici.':
        'Kontuz jaitsiera honetan: bidea nahiko garbi dago, baina malda dauka eta baditu puntu tekniko batzuk. Ez da muturreko jaitsiera, baina bai jostagarria eta esperientzia pixka bat izanda askoz gehiago gozatzen den horietakoa.',
    'El descenso nos devuelve nuevamente hacia Zengotita. Como la intención de esta vuelta no es simplemente regresar a Trabakua, sino enseñar diferentes posibilidades y caminos de la zona, todavía alargamos un poco más el recorrido.':
        'Jaitsierak Zengotita ingurura eramaten gaitu berriro. Hala ere, ez gara zuzenean Trabakuara itzuliko: ibilbidea pixka bat luzatu nahi dugu, inguruko beste bide batzuk erakusteko.',
    'Seguimos otro tramo del trazado de la 7 Pago Mendi Lasterketa en sentido contrario, atravesando nuevamente los caminos de la zona antes de realizar el último descenso.':
        'Horretarako, 7 Pago Mendi Lasterketaren beste zati bat ere kontrako noranzkoan jarraituko dugu.',
    'Finalmente bajamos hasta enlazar con la carretera general. A partir de aquí ya no buscamos más complicaciones: nos quedan aproximadamente 2 kilómetros por carretera para regresar a Trabakua y cerrar la vuelta.':
        'Azken jaitsieraren ondoren errepide nagusira iristen gara. Hemendik aurrera ez dago misteriorik: gutxi gorabehera 2 kilometro geratzen zaizkigu errepidetik Trabakuara itzultzeko eta ibilbidea amaitzeko.',
    'En conjunto, es una ruta pensada más para descubrir caminos y senderos que para ir simplemente de un punto a otro. Aprovechamos pistas conocidas para enlazar pasos menos utilizados, algunos de ellos bastante escondidos, y conocer diferentes maneras de moverse entre Trabakua, Zengotita, Aitzu, Mallabia, Arietzu y Osmagain.':
        'Ibilbide honen helburua ez da soilik kilometroak egitea, baizik eta inguruan dauden bide eta bidezidor ez hain ezagunak erakustea. Pista ezagunak eta pasabide txikiagoak lotzen ditu, horietako batzuk nahiko ezkutuan daudenak, Trabakua, Zengotita, Aitzu, Mallabia, Arietzu eta Osmagain inguruetan mugitzeko aukera berriak ezagutuz.',
    'Hay subidas llevaderas, tramos tranquilos y varias bajadas técnicas y juguetonas que le dan personalidad a la vuelta. Se puede realizar con una BTT convencional, pero para este tipo de recorrido recomendamos especialmente la e-bike, ya que permite moverse con mayor comodidad entre tantos cambios de desnivel y aprovechar mejor todos estos pequeños enlaces y senderos.':
...
BETZUN = {
    ...
    '<p>El track comienza en el propio barrio de <b>Zengotita</b>, a unos 2 kil&oacute;metros de Trabakua. Salimos desde la parte alta del barrio y, junto a una fuente de agua, cogemos el camino en direcci&oacute;n norte para comenzar la subida.</p>':
        '<p>Ibilbidea <b>Zengotita</b> auzoan bertan hasten da, Trabakuatik 2 kilometro ingurura. Auzoaren goiko aldetik abiatzen gara, eta, ur-iturri baten ondoan, iparralderantz doan bidea hartzen dugu, igoera hasteko.</p>',
    '<p>Tenemos por delante unos 2,5 kil&oacute;metros de subida pr&aacute;cticamente continua. Vamos ganando altura poco a poco hasta alcanzar la parte alta, junto al parque e&oacute;lico.</p>':
        '<p>Aurretik 2,5 kilometro inguruko igoera ia etengabea dugu. Altuera irabazten goaz pixkanaka, goiko aldera iritsi arte, parke eolikoaren ondoan.</p>',
    '<p>Una vez arriba, dejamos a nuestra derecha los e&oacute;licos y la cresta que contin&uacute;a hacia <a href="zengotitagane.html">Zengotitagane</a>. Esta vez no seguimos por all&iacute;, sino que giramos hacia la izquierda y continuamos por la parte alta en direcci&oacute;n a Iturzuri.</p>':
...
SARRIMENDI = {
    'Salimos desde Trabakua en direcci&oacute;n norte, por el recorrido que ya hemos utilizado en otras rutas para acercarnos a la zona alta del <a href="oiz.html">Oiz</a>. Los primeros kil&oacute;metros son de subida, dejando poco a poco el valle a nuestra espalda.':
        'Trabakuatik iparralderantz abiatuko gara, <a href="oiz.html">Oiz</a>ko goi-eremura hurbiltzeko erabili dugun ibilbidea jarraituz. Lehen kilometroak gorantz dira, harana gure atzean utziz.',
    'Al llegar a <b>Zengotitagane</b> (km 1,9 &middot; 810 m), dejamos a un lado los e&oacute;licos y nos adentramos de frente en el hayedo. Lo atravesamos hasta <b><a href="iturrizuri.html">Iturzuri</a></b> (km 3,1 &middot; 809 m), donde encontramos un refugio y una fuente.':
        '<b>Zengotitagane</b> (1,9 km &middot; 810 m) iristean, haize-sorgailuak alde batera utzi eta pagadian sartuko gara. <b><a href="iturrizuri.html">Iturzuri</a></b>raino (3,1 km &middot; 809 m) zeharkatuko dugu, non aterpe bat eta iturri bat aurkituko ditugun.',
    'Desde Iturzuri, en lugar de seguir el recorrido m&aacute;s directo hacia Oiz, volvemos a entrar en el hayedo y lo cruzamos hasta salir aproximadamente a media altura de la ladera. A partir de aqu&iacute; recorremos un tramo menos habitual, avanzando por la ladera y subiendo progresivamente hasta encontrarnos de nuevo con la l&iacute;nea de e&oacute;licos, ya muy cerca de las antenas y de la cumbre del <b>Oiz</b> (km 6,2 &middot; 1.019 m).':
        'Iturzuritik, Oizerantz zuzenean jarraitu beharrean, berriro pagadian sartu eta zeharkatuko dugu, mendi-hegalaren erdialdean ateratzeko. Hemendik aurrera, ohiko bidea ez den zati bat zeharkatuko dugu, mendi-hegaletik aurrera eginez eta pixkanaka igotzen haize-sorgailuen lerrora iritsi arte, <b>Oizko</b> tontorretik oso gertu (6,2 km &middot; 1.019 m).',
    'Cogemos entonces la pista que baja junto a los e&oacute;licos en direcci&oacute;n a Garai y la seguimos hasta la conocida <b><a href="potrera.html">curva de la Potrera</a></b> (km 9,8 &middot; 714 m). All&iacute; giramos a la izquierda y entramos en una bajada bastante pedregosa, llamada as&iacute; por la peque&ntilde;a potrera para caballos situada junto al camino.':
    ...
    'Pasada la ermita, no cogemos el camino habitual de la izquierda, sino que seguimos pr&aacute;cticamente de frente y subimos hacia la cresta situada entre Osmagain y Arietzu. Una vez arriba giramos a la izquierda y avanzamos hasta la cruz de <b><a href="arietzu.html">Arietxu</a></b> (km 17,4 &middot; 476 m). Desde all&iacute; descendemos hacia Aitzu y enlazamos con el camino que nos lleva a <b>Mallabia</b> (km 19,7 &middot; 254 m).':
        'Baseliza pasata, ez dugu ohiko bidea hartuko, baizik eta ia zuzen jarraitu eta Osmagain eta Arietzu arteko gailurrerantz igoko gara. Goian, ezkerrera biratu eta <b><a href="arietzu.html">Arietxu</a></b>ko gurutzeraino (17,4 km &middot; 476 m) aurrera egingo dugu. Handik Aitzurantz jaitsi eta <b>Mallabia</b>ra eramango gaituen bidearekin bat egingo dugu (19,7 km &middot; 254 m).',
    'Atravesamos Mallabia en direcci&oacute;n a la parte alta del pueblo, hacia San Pedro, aprovechando para coger agua en la plaza antes de continuar.':
        'Mallabia zeharkatuko dugu herriaren goialderantz, San Pedro aldera, plazan ura hartzeko aprobetxatuz.',
    'Desde San Pedro iniciamos el descenso y pronto nos desviamos a la izquierda por un sendero y una pista de piedra que sirven de atajo hacia la zona industrial. Tomamos como referencia las inmediaciones de Orbea y, tras recorrer unos metros junto a la empresa, cruzamos la carretera. Junto a un paseo encontramos la entrada de una pista que bordea un caser&iacute;o por detr&aacute;s.':
        'San Pedrotik jaisten hasiko gara eta laster ezkerrera desbideratuko gara, industriagunera lasterbide gisa balio duen bidezidor eta harrizko pista batetik. Orbearen inguruak erreferentzia gisa hartuta, enpresaren ondotik metro batzuk egin ondoren, errepidea zeharkatuko dugu. Pasealeku baten ondoan, baserri bat atzetik inguratzen duen pista baten sarrera aurkituko dugu.',
    'Nos alejamos del pol&iacute;gono y comenzamos el ascenso hacia <a href="arteta.html">Arteta</a> hasta alcanzar una pista de piedra m&aacute;s arreglada en su parte baja. Giramos a la izquierda y, algo m&aacute;s adelante, abandonamos nuevamente la pista para entrar en el monte y tomar un atajo en direcci&oacute;n a Mendibil.':
        'Industriagunetik urrundu eta <a href="arteta.html">Arteta</a>rantz igotzen hasiko gara, behealdean hobeto egokitutako harrizko pista batera iritsi arte. Ezkerrera biratu eta, aurrerago, pista berriro utzi eta mendian sartuko gara, Mendibilerantz lasterbide bat hartzeko.',
    'Pasamos por la <b>fuente de Arteta</b> (km 23,8 &middot; 472 m), el &uacute;ltimo punto claro para coger agua, y continuamos hasta la cumbre de <b><a href="mendibil.html">Mendibil</a></b> (km 25,4 &middot; 611 m). Desde arriba tenemos una de las &uacute;ltimas buenas panor&aacute;micas de la jornada y podemos ver parte del terreno recorrido.':
        '<b>Artetako iturritik</b> (23,8 km &middot; 472 m) igaroko gara, ura hartzeko azken puntu argitik, eta <b><a href="mendibil.html">Mendibil</a></b>en tontorreraino jarraituko dugu (25,4 km &middot; 611 m). Goitik, eguneko azken panoramika onenetako bat dugu, eta zeharkatutako lurraldearen zati bat ikus dezakegu.',
    'Desde Mendibil tomamos el camino habitual de regreso a Trabakua, ya principalmente en descenso, para completar una vuelta larga y exigente, con bastante desnivel y continuos cambios de terreno, que recorre buena parte del entorno de Oiz, Zengotita, Mallabia, Arteta y Mendibil.':
        'Mendibiletik Trabakuara itzultzeko ohiko bidea hartuko dugu, jaitsiera nagusian, Oiz, Zengotita, Mallabia, Arteta eta Mendibileko ingurunearen zati handi bat zeharkatzen duen itzuli luze eta gogorra osatzeko, desnibel handiarekin eta etengabeko terreno-aldaketekin.',
    ...
    '28,35 km y +1.366 m de desnivel en un solo circuito, pensado principalmente para trail running o para senderismo de larga duraci&oacute;n. Recorremos parte del macizo del Oiz y buena parte de Mallabia, enlazando zonas altas, barrios, caminos de monte y algunos tramos menos habituales. Hay varios puntos para abastecerse de agua: Iturzuri, Zengotita, Mallabia y la fuente de Arteta, esta &uacute;ltima poco antes de la subida final hacia Mendibil.':
...
LONGA = {
    ...
    'Atravesamos el hayedo hasta llegar a Iturzuri, donde encontramos el refugio y la fuente y podemos aprovechar para coger agua. Desde aqu&iacute; volvemos a meternos en el hayedo, por donde tambi&eacute;n pasa la ruta de <a href="sarrimendi.html">Oiz, Sarrionamendia, Arietxu y Mendibil</a>, y continuamos atraves&aacute;ndolo hasta salir por el otro lado.':
        'Pagadia zeharkatzen dugu Iturzurira iritsi arte, non aterpea eta iturria aurkitzen ditugun, eta ura hartzeko aprobetxatzen dugu. Hemendik pagadian berriro sartzen gara, <a href="sarrimendi.html">Oiz, Sarrionamendia, Arietzu eta Mendibil</a> ibilbidea ere hemendik pasatzen baita, eta zeharkatzen jarraitzen dugu beste aldetik atera arte.',
...
ZENGOTITAOSMAGAIN = {
    ...
    'Arroyo entre helechos y hojarasca en un bosque de con&iacute;feras':
        'Erreka bat garo eta hosto artean konifero-baso batean',
    'Sendero de hierba subiendo hacia una cima arbolada':
        'Belar-bidezidorra zuhaitzez betetako gailur batera igotzen',
    'Cruz de madera en la cima, con vistas a las monta&ntilde;as del entorno':
    ...
    'La ruta sale desde Trabakua en direcci&oacute;n a <b>Zengotita</b>. Despu&eacute;s de unos 2 kil&oacute;metros nos desviamos a la derecha por el camino que sube hacia <b><a href="zengotitagane.html">Zengotitagane</a></b>, aunque apenas permaneceremos medio kil&oacute;metro en &eacute;l. Lo dejamos para girar a la izquierda y dirigirnos hacia la parte baja de Zengotita.':
        'Ibilbidea Trabakuatik abiatzen da, <b>Zengotita</b>rantz. 2 kilometro inguru egin ondoren, eskuinera desbideratuko gara <b><a href="zengotitagane.html">Zengotitagane</a></b> aldera doan bidean, baina apenas kilometro erdi egingo dugu bertan. Bidea utzi eta ezkerrera biratuko dugu Zengotitaren beheko aldera joateko.',
    'Al entrar en el barrio pasamos junto a la fuente, donde podemos coger agua, y continuamos atravesando Zengotita hasta llegar a la ermita, situada en la parte baja.':
        'Auzoan sartzean, iturriaren ondotik pasatuko gara, eta bertan ura hartu ahal izango dugu. Zengotita zeharkatzen jarraituko dugu baselizara iritsi arte, beheko aldean kokatua.',
    'Junto a la ermita cogemos la pista que sale de frente hacia la derecha y comenzamos a ganar altura para alcanzar el inicio de la cresta que nos llevar&aacute; hacia <b>Osmagain</b>. A partir de aqu&iacute; avanzamos por la parte alta, con buenas vistas a ambos lados. A nuestra izquierda quedan Zengotita y el barrio de Osma, mientras que hacia la derecha se abre la vista hacia Berriz, las monta&ntilde;as del Duranguesado y, en d&iacute;as despejados, bastante m&aacute;s lejos.':
        'Baselizaren ondoan, aurrez aurre eskuinera ateratzen den pista hartuko dugu, eta altuera irabazten hasiko gara <b>Osmagain</b>erantz eramango gaituen gailurraren hasierara iristeko. Hemendik aurrera, goiko aldetik jarraituko dugu, bi aldeetara ikuspegi ederrekin. Ezkerrean Zengotita eta Osma auzoa geratzen dira, eta eskuinera Berriz, Durangaldeko mendiak eta, egun argietan, askoz urrunago ikus daitezke.',
    'Continuamos siguiendo la cresta hasta Osmagain y despu&eacute;s hacia <b>Arietzu</b>, donde encontramos otra cruz, el mismo pico de la ruta de <a href="arietzu.html">Osmagain y Arietzu</a>. Desde aqu&iacute; continuamos por la cresta antes de comenzar el descenso.':
        'Gailurretik jarraituko dugu <b>Osmagain</b>eraino eta gero <b>Arietzu</b>rantz, non beste gurutze bat aurkituko dugun, <a href="arietzu.html">Osmagain eta Arietzu</a> ibilbideko gailur berbera. Hemendik aurrera, gailurretik jarraituko dugu jaisten hasi aurretik.',
    'Un poco m&aacute;s adelante dejamos la cresta y comenzamos a bajar hacia la izquierda buscando el barrio de <b>Aitzu</b>.':
        'Aurrerago, gailurra utzi eta ezkerrera jaisten hasiko gara <b>Aitzu</b> auzoaren bila.',
    'Despu&eacute;s de la bajada de Arietzu, la ruta cambia bastante y empiezan a aparecer algunos de sus rincones m&aacute;s curiosos. Pasaremos por zonas h&uacute;medas cubiertas de musgo, peque&ntilde;os caminos m&aacute;s escondidos y tendremos que cruzar un peque&ntilde;o r&iacute;o antes de comenzar a subir de nuevo. Desde Aitzu cogemos direcci&oacute;n a <b>Mallabia</b> en descenso, pero antes de llegar volvemos a desviarnos a la izquierda para bajar hasta la zona del r&iacute;o.':
        'Arietzu jaitsi ondoren, ibilbidea asko aldatzen da eta bere txoko bitxienetako batzuk agertzen hasten dira. Goroldioz estalitako eremu hezeetatik igaroko gara, bide ezkutuagoetatik, eta erreka txiki bat zeharkatu beharko dugu berriro igotzen hasi aurretik. Aitzutik <b>Mallabia</b>rantz jaisten hasiko gara, baina iritsi aurretik ezkerrera desbideratuko gara berriro erreka ingurura jaisteko.',
    'La subida nos va llevando poco a poco hacia Zengotita, pasando tambi&eacute;n por una zona de hayedo. Es un tramo tranquilo y variado, en el que iremos ganando altura progresivamente hasta regresar al barrio.':
...
AXMAKURITURRIZURI = {
    ...
    'En Muniozguren termina el cemento. Al fondo cogemos la pista de piedra que sale a la izquierda y continuamos subiendo por ella, ganando altura poco a poco. Seguimos siempre por la pista principal, sin desviarnos, en una subida bastante suave y llevadera.':
        'Muniozgurenen zementua amaitzen da. Atzean, ezkerretara ateratzen den harrizko pista hartzen dugu eta bertatik igotzen jarraitzen dugu, altuera pixkanaka irabaziz. Beti pista nagusitik jarraitzen dugu, desbideratu gabe, igoera nahiko leun eta eramangarri batean.',
    'En el kil&oacute;metro 7,3 la pista llega a una curva cerrada que gira a la derecha. Si en vez de tomarla sigui&eacute;ramos de frente, hacia la izquierda, podr&iacute;amos bajar hacia <b>Longa</b> y volver a Trabakua por el recorrido de <a href="muniozguren.html">Trabakua, Longa y Muniozguren</a>. Nosotros continuamos por la pista principal, girando a la derecha, en direcci&oacute;n al <b>Oiz</b>.':
        '7,3 kilometroan, pistak eskuinera biratzen duen bihurgune itxi batera iristen da. Bihurgunea hartu beharrean aurrera jarraituz gero, ezkerrera, <b>Longa</b> aldera jaitsi eta Trabakuara itzul gintezke <a href="muniozguren.html">Trabakua, Longa eta Muniozguren</a> ibilbidean zehar. Guk pista nagusitik jarraitzen dugu, eskuinera biratuz, <b>Oiz</b>erantz.',
    'As&iacute; llegamos aproximadamente al <b>kil&oacute;metro 10,3</b>, donde alcanzamos el punto m&aacute;s alto de esta primera subida. A nuestra izquierda nace un peque&ntilde;o sendero. Apenas son unos 200 metros, pero aqu&iacute; cambia completamente el terreno: aparece una cuesta muy fuerte en la que resulta pr&aacute;cticamente imposible subir montado. Con una e-bike, por el peso, empujar cuesta arriba se hace complicado; con una bici normal se sube empujando tranquilamente.':
        'Horrela, gutxi gorabehera <b>10,3 kilometro</b>ra iristen gara, non lehen igoera honen punturik altuena lortzen dugun. Gure ezkerrean bidezidor txiki bat sortzen da. 200 metro inguru baino ez dira, baina hemen lurra erabat aldatzen da: aldapa oso gogor bat agertzen da, eta ia ezinezkoa da bizikletaz igotzea. E-bike batekin, pisuagatik, aldapan gora bultzatzea zaila da; bizikleta normal batekin, bultzaka igotzen da lasai.',
    'Es un tramo corto pero intenso. Este antiguo camino fue en su d&iacute;a una de las rutas de BTT de referencia del <b>Bajo Deba</b>, aunque con el tiempo se fue perdiendo y lleg&oacute; a quedar pr&aacute;cticamente abandonado. Recientemente se ha recuperado gracias, entre otras cosas, al paso de la <a href="7pago.html">7 Pago Mendi Lasterketa</a> de Mallabia.':
        'Tarte laburra baina bizia da. Antzinako bide hau bere garaian <b>Debabarrena</b>ko BTT ibilbide erreferenteetako bat izan zen, baina denborarekin galtzen joan zen eta ia erabat abandonatuta geratu zen. Duela gutxi berreskuratu da, besteak beste, Mallabiko <a href="7pago.html">7 Pago Mendi Lasterketa</a>ren igarotzeari esker.',
    'Superado este repecho salimos a una preciosa campa. Continuamos subiendo junto a una borda y el paisaje empieza a abrirse de verdad. De frente aparecen los aerogeneradores del cordal de Oiz y, si miramos hacia atr&aacute;s, las vistas alcanzan buena parte de las monta&ntilde;as y valles que hemos ido dejando atr&aacute;s.':
        'Aldapa hau gaindituta, zelai eder batera ateratzen gara. Igotzen jarraitzen dugu borda baten ondoan, eta paisaia benetan irekitzen hasten da. Aurrean Oizko mendilerroko haize-sorgailuak agertzen dira, eta atzera begiratzen badugu, atzean utzi ditugun mendi eta haranen zati handi bat ikusten dugu.',
    'Aqu&iacute; no hay camino: subimos la campa campo a trav&eacute;s hasta alcanzar la parte alta, donde cruzamos un vallado y accedemos a la pista de los aerogeneradores.':
        'Hemen ez dago biderik: zelaia zeharkatzen dugu goiko aldera iritsi arte, non hesi bat zeharkatu eta haize-sorgailuen pistara iristen garen.',
    'Una vez arriba, giramos a la izquierda y continuamos junto a los e&oacute;licos en direcci&oacute;n a <b><a href="iturrizuri.html">Iturzuri</a></b>. All&iacute; encontramos el refugio y la fuente, un buen punto para reponer agua antes de continuar.':
        'Behin goian, ezkerrera biratu eta haize-sorgailuen ondotik jarraitzen dugu <b><a href="iturrizuri.html">Iturzuri</a></b>rantz. Han aterpea eta iturria aurkitzen ditugu, ura berriz hornitzeko puntu ona aurrera jarraitu aurretik.',
    'Desde Iturzuri nos adentramos en el hayedo y lo atravesamos en busca de <b><a href="zengotitagane.html">Zengotitagane</a></b>. Al salir del bosque nos acercamos hasta &eacute;l recorriendo una cresta bastante llana y abierta, con buenas vistas a ambos lados.':
        'Iturzuritik pagadian sartzen gara eta zeharkatzen dugu <b><a href="zengotitagane.html">Zengotitagane</a></b> bila. Basotik ateratzean, gailur nahiko lau eta ireki batetik hurbiltzen gara, bi aldeetara ikuspegi onekin.',
...
AMARAUNE = {
    ...
    '<p>Esta ruta sigue el recorrido de la Amaraune Lasterketa de Berriz. Aunque no parte de <b>Trabakua</b>, hemos querido incluirla porque pasa por una zona muy habitual en nuestras rutas, <b>Iturzurigaina</b>, y porque nos permite conocer nuevos senderos y caminos muy bonitos que normalmente no utilizamos. S&iacute; queremos hacer esta ruta, pero sin salir de Berriz. Para ello, enlazamos Iturzurigaina a trav&eacute;s de <b><a href="zengotitagane.html">Zengotitagane</a></b>.</p>\n    <p>Salimos desde Berriz, desde la zona situada junto a la iglesia, y comenzamos a subir hacia el barrio de <b>Besoita</b>. Desde all&iacute; cogemos la pista que asciende hacia la <b><a href="sancristobal.html">ermita de San Kristobal Txiki</a></b>.</p>\n    <p>Antes de llegar a la ermita, en plena curva, dejamos la pista y nos metemos a mano derecha. Comienza aqu&iacute; un bonito sendero que sube por detr&aacute;s del monte <b>Gaztelumendi</b> y que, poco a poco, nos acerca hasta la propia ermita de San Kristobal Txiki.</p>\n    <p>Desde la ermita giramos a la derecha, como hemos hecho en otras rutas, y continuamos hacia el caser&iacute;o <b><a href="betzun.html">Betzun</a></b>, situado en la parte alta de <b>Zengotita</b>. A partir de aqu&iacute; tomamos direcci&oacute;n norte y el camino comienza a subir con fuerza hacia Iturzurigaina, una zona que conocemos bien por su cercan&iacute;a a <b><a href="iturrizuri.html">Iturzuri</a></b> y Zengotitagane.</p>\n    <p>Despu&eacute;s de alcanzar la parte alta y m&aacute;s llana, giramos a la izquierda y volvemos a meternos entre &aacute;rboles, entrando en una zona de bosque bastante cerrado.</p>\n    <p>A partir de este punto comienza una de las partes m&aacute;s interesantes de la ruta. Vamos enlazando pistas y caminos entre el bosque, con algunos claros que nos dejan buenas vistas, mientras empezamos a contemplar la zona de los e&oacute;licos de <b><a href="oiz.html">Oiz</a></b>. Continuamos a media ladera, atravesando esta parte de la monta&ntilde;a sin necesidad de subir hasta la cima.</p>\n    <p>M&aacute;s adelante el recorrido cambia completamente. Giramos y comenzamos el descenso por una sucesi&oacute;n de senderos escondidos entre el bosque, muy bonitos tanto para correr como para hacer senderismo. Es una zona diferente a los caminos que solemos utilizar y uno de los motivos por los que merece la pena conocer este recorrido.</p>\n    <p>Estos senderos nos van llevando hacia <b>Sarrimendia</b>. Una vez alcanzada su parte alta, antes de iniciar la bajada hacia Berriz, tendremos que subir hasta el &uacute;ltimo pico, Gaztelumendi. Desde all&iacute; comenzamos el descenso, regresando nuevamente por la zona del barrio de Besoita para completar la vuelta.</p>':
        '<p>Ibilbide hau Berrizko Amaraune Lasterketaren ibilbideari jarraitzen dio. Nahiz eta <b>Trabakua</b>tik ez abiatu, ibilbide hau sartu nahi izan dugu, <b>Iturzurigaina</b> ingurutik pasatzen delako, gure ibilbideetan ohikoa den eremua baita. Gainera, normalean erabiltzen ez ditugun bide eta bidezidor eder berriak ezagutzeko aukera ematen digu. Ibilbide hau egin nahi dugu, baina Berriztik atera gabe. Horretarako, Iturzurigaina <b><a href="zengotitagane.html">Zengotitagane</a></b> bidez lotuko dugu.</p>\n    <p>Berriztik abiatuko gara, elizaren ondoko eremutik, eta <b>Besoita</b> auzorantz igotzen hasiko gara. Handik, <b><a href="sancristobal.html">San Kristobal Txiki ermitara</a></b> doan pista hartuko dugu.</p>\n    <p>Ermitara iritsi baino lehen, bihurgunean, pista utzi eta eskuinera sartuko gara. Hemen hasten da <b>Gaztelumendi</b> mendiaren atzetik igotzen den bidezidor polit bat, eta, pixkanaka, San Kristobal Txiki ermitara hurbiltzen gaitu.</p>\n    <p>Ermitatik eskuinera biratu, beste ibilbide batzuetan egin dugun bezala, eta <b>Zengotita</b>ko goialdean dagoen <b><a href="betzun.html">Betzun</a></b> baserrirantz jarraituko dugu. Hortik aurrera, iparralderantz joko dugu, eta bidea indarrez igotzen hasiko da Iturzurigainarantz, <b><a href="iturrizuri.html">Iturzuri</a></b> eta Zengotitagane ingurutik hurbil dagoen eremua.</p>\n    <p>Goialde lauenera iritsi ondoren, ezkerrera biratu eta berriro zuhaitzen artean sartuko gara, baso itxi samar batean sartuz.</p>\n    <p>Puntu honetatik aurrera, ibilbidearen zatirik interesgarrienetako bat hasten da. Basoan zehar pistak eta bideak lotuz goaz, ikuspegi onak eskaintzen dizkiguten soilgune batzuekin, <b><a href="oiz.html">Oiz</a></b>ko haize-sorgailuen eremua ikusten hasten garen bitartean. Mendi-hegalaren erdian jarraituko dugu, mendiaren zati hau zeharkatuz, gailurreraino igo beharrik gabe.</p>\n    <p>Aurrerago, ibilbidea erabat aldatzen da. Biratu eta basoan ezkutatutako bidezidor batzuetatik jaisten hasiko gara, bai korrika egiteko bai mendi-ibiliak egiteko oso politak direnak. Normalean erabiltzen ditugun bideetatik desberdina den eremu bat da, eta horregatik merezi du ibilbide hau ezagutzea.</p>\n    <p>Bidezidor hauek <b>Sarrimendi</b>rantz eramango gaituzte. Goialdera iritsitakoan, Berrizerantz jaisten hasi aurretik, azken gailurrera igo beharko dugu, Gaztelumendira. Handik jaisten hasiko gara, Besoita auzoko eremutik itzuliz, itzulia osatzeko.</p>',
...
ASTARLOKOATXA = {
    ...
    'alt="Aerogenerador visto entre las ramas de los pinos, sobre el cordal"':
        'alt="Aerosorgailua pinuen adarren artetik ikusita, gandorraren gainean"',
    'alt="Sendero de subida entre hayas j&oacute;venes, con una marca roja pintada en un tronco"':
        'alt="Igoerako bidezidorra pago gazteen artean, enbor batean margotutako marka gorri batekin"',
    'alt="Sendero entre &aacute;rboles con luz filtrada entre las hojas"':
        'alt="Bidezidorra zuhaitzen artean, hostoen artetik iragazitako argiarekin"',
    'alt="Camino junto a una alambrada en el cordal, con vistas panor&aacute;micas a los valles, caser&iacute;os y el mar al fondo"':
        'alt="Bidea alanbre-hesi baten ondoan gandorrean, haran, baserri eta itsasorako ikuspegi panoramikoekin atzealdean"',
    'alt="Borda de piedra con tejado verde entre pinos altos, junto al camino"':
        'alt="Harrizko borda teilatu berdearekin pinu altuen artean, bidearen ondoan"',
    'alt="Camino herboso entre &aacute;rboles, formando un t&uacute;nel verde"':
        'alt="Bide belartsua zuhaitzen artean, tunel berde bat osatuz"',
    'alt="Vistas panor&aacute;micas desde el cordal rocoso, con el mar asom&aacute;ndose al fondo"':
        'alt="Ikuspegi panoramikoak gandor harritsutik, itsasoa atzealdean agertzen dela"',
    'alt="Alambrada junto a un prado, con un monte boscoso al fondo"':
        'alt="Alanbre-hesia larre baten ondoan, mendi baso bat atzealdean"',
    'alt="Sendero herboso entre una verja met&aacute;lica y &aacute;rboles"':
        'alt="Bidezidor belartsua langa metaliko baten eta zuhaitzen artean"',
    'alt="Vistas panor&aacute;micas desde el cordal, con las monta&ntilde;as extendi&eacute;ndose hasta el horizonte"':
        'alt="Ikuspegi panoramikoak gandorretik, mendiak zerumugaraino zabaltzen direla"',
    'alt="Fila de aerogeneradores sobre el cordal, con antenas en la cima al fondo"':
...
GARAIMAGUNA = {
    ...
    '<p>A la entrada de Garai giramos a la derecha por una pista hacia el monte. Seguimos parte del recorrido del <a href="https://www.instagram.com/astotrail" target="_blank" rel="noopener noreferrer">Asto Trail</a> de Garai, pero en sentido contrario. M&aacute;s adelante lo dejamos y avanzamos hacia el oeste por detr&aacute;s de A&ntilde;ao, descendiendo despu&eacute;s hacia un &aacute;rea recreativa.</p>':
        '<p>Garaiko sarreran, eskuinera biratzen dugu mendi aldera doan pista batetik. Garaiko <a href="https://www.instagram.com/astotrail" target="_blank" rel="noopener noreferrer">Asto Trail</a>aren ibilbidearen zati bat jarraitzen dugu, baina kontrako norabidean. Aurrerago utzi eta mendebalderantz aurrera egiten dugu A&ntilde;aoren atzetik, gero aisialdi-gune baterantz jaitsiz.</p>',
    ...
    '<p>Rodeamos la cumbre de Askako por varios senderos escondidos, bonitos y algo t&eacute;cnicos, aunque ciclables. Despu&eacute;s volvemos a la carretera y seguimos hacia <b>Zengotitagane</b>. Antes del regreso nos acercamos a <b>Axmakur</b> (km 26,8 &middot; 898 m) para disfrutar de las vistas y alargar la ruta.</p>':
        '<p>Askakoko tontorra inguratzen dugu ezkutuko bidezidor polit eta tekniko batzuetatik, nahiz eta bizikletaz ibiltzeko modukoak izan. Ondoren, errepidera itzultzen gara eta <b>Zengotitagane</b>rantz jarraitzen dugu. Itzuli aurretik, <b>Axmakur</b>rera (km 26,8 &middot; 898 m) hurbiltzen gara ikuspegiaz gozatzeko eta ibilbidea luzatzeko.</p>',
    '<p>Pasamos por <b><a href="axmakuriturrizuri.html">Iturzuri</a></b>, donde podemos coger agua, y seguimos hasta Zengotitagane (km 28,9 &middot; 816 m). All&iacute; tomamos la pista de descenso hacia <b>Osma</b>, que nos lleva casi hasta la carretera general. Giramos hacia Trabakua y, tras unos dos kil&oacute;metros, llegamos al punto de partida.</p>':
        '<p><b><a href="axmakuriturrizuri.html">Iturzuri</a></b>tik igarotzen gara, non ura har dezakegun, eta Zengotitaganeraino jarraitzen dugu (km 28,9 &middot; 816 m). Han, <b>Osma</b>rantz jaisten den pista hartzen dugu, errepide nagusiraino ia eramaten gaituena. Trabakuarantz biratzen dugu eta, bi kilometro inguru egin ondoren, abiapuntura iristen gara.</p>',
...
SANPEDROBIDARTE = {
    ...
    '<p>En nuestra opini&oacute;n, esta ruta gana bastante haci&eacute;ndola en sentido contrario. El recorrido es todav&iacute;a m&aacute;s bonito, aunque tambi&eacute;n algo m&aacute;s duro, sobre todo en algunos tramos. Si se hace al rev&eacute;s, la recomendamos para gente que ya est&aacute; un poco rodada y acostumbrada a andar por el monte, no para hacer con ni&ntilde;os peque&ntilde;os.</p>':
        '<p>Gure ustez, ibilbide hau kontrako norabidean egitea ere posible da, nahiz eta zailagoa izan. Ibilbidea alderantziz eginez gero, gomendatzen dugu jendea pixka bat ibilia eta mendian ibiltzen ohituta egotea, ez ume txikiekin egiteko.</p>',
    'Salimos de Trabakua en direcci&oacute;n a Ermua por la carretera, pero la dejamos enseguida para girar a la izquierda y empezar a subir por un camino de cemento. Aproximadamente en el km 2 llegamos al cruce de <b>Arteta</b>, en la <a href="trabakua.html">vuelta de Asuntza</a>. En el mismo cruce seguimos por el sendero que sale pr&aacute;cticamente de frente, entre eucaliptos, y que nos lleva hasta la <b>fuente de Arteta</b> (km 2,6 &middot; 457 m).':
        'Trabakuatik irteten gara Ermuarantz errepidetik, baina berehala uzten dugu ezkerretara biratzeko eta zementuzko bide batetik igotzen hasteko. Gutxi gorabehera 2. kilometroan <b>Arteta</b>ko bidegurutzera iristen gara, <a href="trabakua.html">Asuntzako itzulian</a>. Bidegurutze berean, aurrerantz doan bidezidorretik jarraitzen dugu, eukaliptoen artean, eta <b>Artetako iturri</b>ra eramaten gaitu (2,6 km &middot; 457 m).',
    'La fuente est&aacute; un poco escondida entre los &aacute;rboles y tiene agua durante todo el a&ntilde;o. El agua brota directamente de una esquina de la roca y cae al pil&oacute;n. Adem&aacute;s, es un lugar curioso porque el mismo riachuelo que vamos a seguir a continuaci&oacute;n nace pr&aacute;cticamente all&iacute; mismo.':
        'Iturria zuhaitzen artean ezkutatuta dago eta urte osoan zehar ura du. Ura harkaitzaren izkina batetik zuzenean ateratzen da eta askara erortzen da. Gainera, leku bitxia da, jarraituko dugun errekasto bera hortxe bertan jaiotzen baita.',
    'Despu&eacute;s de pasar por la fuente seguimos junto al riachuelo. A partir de aqu&iacute; iremos descendiendo en direcci&oacute;n sureste, procurando mantenernos por su margen izquierda y avanzando siempre cerca del agua. Es una zona de senderos poco transitados, algunos algo cerrados, pero por los que se puede pasar. Poco a poco el camino se va abriendo y termina convirti&eacute;ndose en una pista que nos lleva hasta Berano Txiki.':
        'Iturria igaro ondoren, errekastoaren ondoan jarraitzen dugu. Hemendik aurrera, hego-ekialderantz jaisten joango gara, bere ezkerreko ertzetik mantentzen saiatuz eta beti uraren ondoan aurrera eginez. Gutxi ibilitako bidezidorren eremua da, batzuk pixka bat itxita, baina pasatzeko modukoak. Poliki-poliki, bidea irekitzen joaten da eta Berano Txikiraino eramaten gaituen pista bihurtzen da.',
    'Cruzamos la carretera y volvemos a meternos en otro sendero que contin&uacute;a junto al r&iacute;o en direcci&oacute;n a la zona de la <b>cantera de Ermua</b>. Es un tramo muy bonito, con bastantes escaleras y alg&uacute;n peque&ntilde;o puente. Ya cerca de la cantera salimos a la carretera que sube hacia Berano Txiki y continuamos bajando hasta llegar a la carretera general.':
        'Errepidea gurutzatzen dugu eta berriro sartzen gara <b>Ermuko harrobia</b>ren eremurantz doan bidezidor batean. Oso tarte polita da, eskailera askorekin eta zubi txikiren batekin. Harrobitik gertu, Berano Txikira igotzen den errepidera ateratzen gara eta jaisten jarraitzen dugu errepide nagusira iritsi arte.',
    'Cruzamos la carretera, ya en Ermua, y buscamos el bidegorri que va junto al r&iacute;o. Lo seguimos hasta la zona del campo de f&uacute;tbol y desde all&iacute; continuamos hacia la parte alta de <b>Ongarai</b>, donde enlazamos con la pista que nos dar&aacute; paso hacia San Pedro de Bidarte.':
        'Errepidea gurutzatzen dugu, Ermuan jada, eta ibaiaren ondoan doan bidegorria bilatzen dugu. Futbol-zelaiaren eremuraino jarraitzen dugu eta handik <b>Ongarai</b>ko goiko alderantz jarraitzen dugu, non San Pedro de Bidarterantz eramango gaituen pistarekin bat egiten dugun.',
    'Al principio de esta pista encontraremos un par de verjas met&aacute;licas. Si est&aacute;n cerradas, las abriremos para pasar y las dejaremos exactamente como estaban. A partir de aqu&iacute; continuamos suavemente hacia San Pedro por buenas pistas y caminos, con bonitas vistas hacia Mallabia y todo el entorno.':
        'Pista honen hasieran metalezko bi hesi aurkituko ditugu. Itxita badaude, ireki egingo ditugu pasatzeko eta zeuden bezala utziko ditugu. Hemendik aurrera, San Pedro aldera jarraitzen dugu, pista eta bide onetatik, Mallabia eta inguru osoaren ikuspegi ederrez gozatuz.',
    'Al llegar a <b>San Pedro de Bidarte</b> (km 9,2 &middot; 257 m) cruzamos la carretera y continuamos de frente, entre los caser&iacute;os de la parte alta del barrio. Desde aqu&iacute; seguimos ganando altura por la loma, con buenas vistas hacia Arteta, Berano Goitia y buena parte de la zona por la que hemos ido pasando durante la ruta.':
        '<b>San Pedro de Bidarte</b>ra iristean (9,2 km &middot; 257 m), errepidea gurutzatzen dugu eta aurrerantz jarraitzen dugu, auzoaren goiko aldeko baserrien artean. Hemendik, altuera irabazten jarraitzen dugu muinoan zehar, Arteta, Berano Goitia eta ibilbidean zehar igaro garen eremuaren zati handi baten ikuspegi ederrekin.',
    'Al terminar la loma alcanzamos la carretera general, en la zona de Salamatu, pero apenas la tocamos. Nada m&aacute;s salir giramos a la derecha y continuamos por carretera de asfalto hacia Apoita y San Mart&iacute;n, la misma zona desde la que tambi&eacute;n podemos volver a subir hacia Trabakua.':
        'Muinoa amaitzean, errepide nagusira iristen gara, Salamatuko eremuan, baina ia ez dugu ukitzen. Irten bezain laster, eskuinera biratu eta asfaltozko errepidetik jarraitzen dugu Apoita eta San Martin aldera, Trabakuara itzultzeko ere erabil dezakegun eremu berera.',
    'Ahora descendemos hasta llegar nuevamente al r&iacute;o y comenzamos otra peque&ntilde;a subida. Poco despu&eacute;s encontramos un camino a mano derecha y lo cogemos para bajar hacia el pol&iacute;gono de Goitondo. Si queremos hacer la vuelta m&aacute;s directa, basta con seguir de frente por el camino principal, sin coger este desv&iacute;o. Saldremos de nuevo a la carretera general y desde all&iacute; podremos regresar directamente a Trabakua.':
        'Orain, berriro ere ibaira iritsi arte jaisten gara eta igoera txiki bat hasten dugu. Handik gutxira, eskuinean bide bat aurkitzen dugu eta hartu egiten dugu Goitondoko industrialdera jaisteko. Itzuli zuzenagoa egin nahi badugu, nahikoa da aurrerantz jarraitzea bide nagusitik, desbideratze hau hartu gabe. Berriro ere errepide nagusira aterako gara eta handik Trabakuara zuzenean itzuli ahal izango gara.',
    'Entramos en el pol&iacute;gono y, despu&eacute;s de avanzar unos metros, giramos a la izquierda para comenzar la &uacute;ltima subida. Subimos por el bonito barrio de <b><a href="goita.html">Goita</a></b>, una zona muy tranquila de caser&iacute;os desde la que se disfrutan muy buenas vistas a los dos lados del valle. Desde all&iacute; continuamos hasta regresar a Trabakua, donde terminamos la ruta.':
...
SANCRISTOBALOIZ = {
    ...
    'Salimos de <b>Trabakua</b> y, tras unos primeros kil&oacute;metros, nos acercamos al barrio de <b>Zengotita</b>. Seguimos por la carretera de barrio hasta llegar al caser&iacute;o de <b><a href="betzun.html">Betzun</a></b> (km 4,2 &middot; 538 m). Pasado el caser&iacute;o continuamos subiendo y, un poco m&aacute;s adelante, cruzamos un peque&ntilde;o r&iacute;o.':
        '<b>Trabakua</b>tik irteten gara eta, lehenengo kilometro batzuen ondoren, <b>Zengotita</b> auzora hurbiltzen gara. Auzoko errepidetik jarraitzen dugu <b><a href="betzun.html">Betzun</a></b> baserrira iritsi arte (4,2 km &middot; 538 m). Baserria igaro ondoren, igotzen jarraitzen dugu, eta, aurreraxeago, erreka txiki bat zeharkatzen dugu.',
    'En general perdemos altura hasta llegar a la zona de <b><a href="sancristobal.html">San Kristobal Txiki</a></b>. Continuamos hacia la derecha, dejando la ermita a nuestra izquierda, y enseguida alcanzamos la parte m&aacute;s alta de ese camino. A mano derecha tenemos una fuente de agua.':
        'Oro har, altuera galtzen dugu <b><a href="sancristobal.html">San Kristobal Txiki</a></b>ko eremura iritsi arte. Eskuinera jarraitzen dugu, baseliza gure ezkerrean utziz, eta berehala iristen gara bide horretako punturik altuenera. Eskuinean ur-iturri bat dugu.',
    'Desde aqu&iacute; empezamos a bajar en direcci&oacute;n a <b>Garai</b>. Tras aproximadamente 1,5 km de bajada, en plena curva (km 7,1 &middot; 385 m) dejamos esta pista y cogemos otra por la que volvemos a subir. La seguimos hasta llegar al cruce que separa la zona de San Kristobal y Oiz de la de <b>Zengotitagane</b> e <b>Iturzuri</b>.':
        'Hemendik <b>Garai</b>rantz jaisten hasten gara. 1,5 km inguruko jaitsieraren ondoren, bihurgune batean (7,1 km &middot; 385 m) pista hau utzi eta berriro igotzen den beste bat hartzen dugu. San Kristobal eta Oizko eremua <b>Zengotitagane</b> eta <b>Iturzuri</b>ko eremutik bereizten duen bidegurutzeraino jarraitzen dugu.',
    'En el cruce cogemos el camino de la izquierda y seguimos subiendo suavemente hacia <b>San Kristobal</b> (km 12,5 &middot; 787 m).':
        'Bidegurutzean ezkerreko bidea hartu eta <b>San Kristobal</b>erantz igotzen jarraitzen dugu (12,5 km &middot; 787 m).',
    ...
    'Justo detr&aacute;s de la ermita sale una peque&ntilde;a pista que parece que no lleva a ning&uacute;n sitio. Si bajamos unos metros por ella encontramos la Fuente Oiz (km 12,8 &middot; 780 m), bastante escondida y f&aacute;cil de pasar por alto. No es muy conocida, as&iacute; que viene bien saber que est&aacute; ah&iacute; para poder coger agua si la necesitamos.':
        'Baselizaren atzean, inora ez doala dirudien pista txiki bat ateratzen da. Metro batzuk jaisten baditugu, Oiz Iturria aurkitzen dugu (12,8 km &middot; 780 m), nahiko ezkutatuta eta erraz oharkabean pasatzeko modukoa. Ez da oso ezaguna, beraz, ondo dago jakitea hor dagoela, ura behar badugu har dezakegula jakiteko.',
    ...
    'A partir de aqu&iacute; entramos en un tramo bonito y bastante solitario que nos lleva hacia la zona del caser&iacute;o y la granja de <b>Kortaun</b>. M&aacute;s adelante enlazamos de nuevo con pistas y comenzamos a bajar hacia el <b>monasterio de Ziortza</b> (km 22 &middot; 313 m).':
        'Hemendik aurrera, zati polit eta nahiko bakarti batean sartzen gara, <b>Kortaun</b>go baserri eta granjarantz eramaten gaituena. Aurrerago, berriro ere pista batzuekin lotzen gara eta <b>Ziortzako monasterio</b>rantz jaisten hasten gara (22 km &middot; 313 m).',
    ...
    'Al terminar la subida llegamos a la zona del caser&iacute;o de <b><a href="muniozguren.html">Muniozguren</a></b> (km 25,5 &middot; 540 m). Desde aqu&iacute; nos quedan aproximadamente 6 kil&oacute;metros hasta Trabakua, atravesando el bonito y tranquilo barrio de <b>Gerea</b> hasta regresar al alto.':
...
AXMAKURANDIKOA = {
    ...
    'alt="Canal de la Central Patala, con el edificio de la central y un puente de piedra al fondo"':
        'alt="Patala zentralaren ubidea, zentralaren eraikina eta harrizko zubi bat hondoan"',
    'alt="Canal de la Central Patala entre los &aacute;rboles, aguas arriba"':
        'alt="Patala zentralaren ubidea zuhaitzen artean, uretik gora"',
    ...
    'Continuamos por esta pista hasta llegar abajo del todo, donde enlazamos con el camino que viene de <b>Andikoa</b> (km 16,5 &middot; 186 m). Garai queda ya muy cerca hacia la derecha, pero nosotros giramos a la izquierda para empezar poco a poco el regreso.':
        'Pista honetatik jarraitzen dugu behealdera iritsi arte, non <b>Andikoa</b>tik datorren bidearekin lotzen garen (16,5 km &middot; 186 m). Garai oso gertu dago eskuinaldera, baina gu ezkerrera biratzen gara itzulerari ekiteko.',
...
SANTAMANAZARANDIKOA = {
    ...
    '<p>Esta no es una ruta para todo el mundo. Si vamos inseguros encima de la bici o no nos desenvolvemos bien en terreno t&eacute;cnico, hay alg&uacute;n tramo que puede hacerse inc&oacute;modo. Pero con algo de manejo merece mucho la pena. Es una vuelta muy completa, con buenos cambios de paisaje, subidas exigentes, bajadas largas y entretenidas, barrios rurales y varios rincones muy bonitos. Perfecta para pasar una ma&ntilde;ana o una tarde.</p>':
        '<p>Hau ez da mundu guztiarentzako ibilbidea. Bizikletan ziur ez bagaude edo lur teknikoan ondo moldatzen ez bagara, tarte batzuk deseroso egin daitezke. Baina trebetasun pixka batekin, merezi du: ibilbide osoa da, paisaiak etengabe aldatzen dira, igoera gogorrak ditu, jaitsiera luze eta entretenigarriak, eta bidean baserri-inguruak eta txoko polit asko agertzen dira. Goiz edo arratsalde bat pasatzeko aukera ezin hobea da.</p>',
    ...
    '<p>Desde all&iacute; seguimos las marcas del GR durante un tramo para llegar a la zona de Goierri. En uno de los cruces cogemos el camino del medio y, poco despu&eacute;s, lo dejamos para entrar por una pista a mano derecha que empieza a subir con fuerza.</p>':
        '<p>Handik, GRaren markei jarraitzen diegu tarte batean, Goierriko eremura iristeko. Bidegurutze batean, erdiko bidea hartzen dugu, eta, handik gutxira, utzi egiten dugu, eskuineko pista batetik sartzeko, indarrez igotzen hasten dena.</p>',
    '<p>Aqu&iacute; comienza una de las partes m&aacute;s interesantes de la ruta. Vamos subiendo hacia <b>Santama&ntilde;azar</b>. Al principio la pista se sube bastante bien, especialmente con e-bike, pero m&aacute;s arriba el terreno cambia y aparecen zonas de piedra, placas m&aacute;s lisas y tierra con zanjas. Con algo de t&eacute;cnica sigue siendo ciclable, aunque puede tocar echar pie a tierra durante unos metros.</p>':
        '<p>Hemen hasten da ibilbideko zatirik interesgarrienetako bat. <b>Santama&ntilde;azar</b> aldera igotzen ari gara. Hasieran, pista nahiko ondo igotzen da, batez ere e-bikearekin, baina gorago lurra aldatu egiten da eta harri eremuak, plaka lauagoak eta erretenez betetako lurra agertzen dira. Teknika pixka batekin, bizikletaz ibiltzeko modukoa da oraindik, nahiz eta metro batzuetan oina lurrean jarri behar izan.</p>',
    ...
    '<p>Volvemos hacia la parte alta del barrio y continuamos junto a los caser&iacute;os. Poco despu&eacute;s dejamos el asfalto y empezamos a descender por un sendero que termina enlazando con una pista.</p>':
        '<p>Auzoaren goialdera itzultzen gara eta baserrien ondoan jarraitzen dugu. Handik gutxira, asfaltoa utzi eta pista batekin lotzen den bidexka batetik jaisten hasten gara.</p>',
    '<p>La bajada hacia la zona de Abadi&ntilde;o es larga y muy agradecida. Primero por una pista de piedra bastante limpia y c&oacute;moda; m&aacute;s abajo, entre caser&iacute;os, prados y peque&ntilde;as carreteras de barrio pr&aacute;cticamente sin tr&aacute;fico.</p>':
        '<p><b>Abadi&ntilde;o</b>ko eremurantz doan jaitsiera luzea eta oso atsegina da. Lehenik, harri pista nahiko garbi eta eroso batetik; beherago, baserri, zelai eta ia trafikorik gabeko auzo errepide txikien artean.</p>',
    '<p>Esta parte de la vuelta es especialmente bonita por las vistas. Bajamos hacia Matiena a trav&eacute;s del <b>Gaztelua</b>, desde donde se abre buena parte de los montes del Duranguesado, desde Anboto hasta Mugarra.</p>':
        '<p>Itzuliaren zati hau bereziki polita da ikuspegiengatik. Matienarantz jaisten gara <b>Gaztelua</b>tik, eta handik Durangaldeko mendien zati handi bat zabaltzen da, Anbototik Mugarraraino.</p>',
...
MARKINAKOBAU = {
    ...
    '<p>Esta vez no salimos desde <b>Trabakua</b>. En la web hay varias rutas que permiten enlazar hasta esta zona (<b><a href="markinabolibar.html">Trabakua, Zenarruza, Zeinka, Urregarai y Markina</a></b>, <b><a href="kalamua.html">Urko, Kalamua, San Migel y Mendibil</a></b> o <b><a href="urregarai.html">Iturreta, Markina y Urregarai</a></b>), pero si las uni&eacute;ramos con este recorrido la vuelta se alargar&iacute;a demasiado. Por eso, para disfrutarla mejor y no convertirla en una jornada excesivamente larga, decidimos empezar directamente desde <b>Markina-Xemein</b>.</p>':
        '<p>Oraingoan ez gara <b>Trabakua</b>tik abiatzen. Webgunean hainbat ibilbide daude inguru honetara iristeko (<b><a href="markinabolibar.html">Trabakua, Zenarruza, Zeinka, Urregarai eta Markina</a></b>, <b><a href="kalamua.html">Urko, Kalamua, San Migel eta Mendibil</a></b> edo <b><a href="urregarai.html">Iturreta, Markina eta Urregarai</a></b>), baina ibilbide honekin lotuko bagenitu, itzulia luzeegia izango litzateke. Horregatik, hobeto gozatzeko eta egun luzeegia ez izateko, <b>Markina-Xemein</b>dik zuzenean hastea erabaki genuen.</p>',
...
MALLUKITOKO = {
    ...
    'alt="Entrada del Mallukitokiko bunkerra, una losa de hormig&oacute;n semienterrada entre la vegetaci&oacute;n"':
        'alt="Mallukitokiko bunkerraren sarrera, hormigoizko xafla erdi-lurperatua landaredi artean"',
    ...
    '<p>En torno al km 7, en plena curva, dejamos a nuestra derecha un camino que sube hacia la zona de <b>Ariztieder</b> y <b>Kobaria</b>. Por ah&iacute; podemos enlazar con la ruta que hicimos anteriormente pasando por <b><a href="markinakobau.html">Kobaria koba, Berriatua y Larruskain</a></b>.</p>':
        '<p>7 km inguruan, bihurgune betean, eskuinean <b>Ariztieder</b> eta <b>Kobaria</b> aldera igotzen den bide bat uzten dugu. Hortik <b><a href="markinakobau.html">Kobaria kobatik, Berriatua eta Larruskainetik</a></b> igarota egin genuen ibilbidearekin lotu gaitezke.</p>',
...
SANTAEUFEMIA = {
    ...
    'alt="Escalinata de piedra subiendo hacia la ermita de Santa Eufemia, vista de lado entre roca caliza y un muro de piedra"':
        'alt="Harrizko eskalinata Santa Eufemia ermitarantz gora, albotik ikusita, kareharriaren eta harrizko horma baten artean"',
    ...
    '    <p>Pasamos junto a un restaurante y seguimos ascendiendo. M&aacute;s adelante dejamos el asfalto y entramos ya en pista. Desde aqu&iacute; la ruta cambia bastante y comienza una subida m&aacute;s larga, enlazando varias pistas y ganando altura poco a poco hasta acercarnos al alto de <b>Lekoitzgane</b>.</p>':
        '<p><b>Markina-Xemein</b>dik mendebaldera abiatu eta lehen kilometroetan <b>Donejakue bide</b>ari jarraitzen diogu, <b><a href="iruzubieta.html">Iruzubieta</a></b>rantz. Hasiera lasaia da, bide zabal eta erosoan, eta pixkanaka altuera hartzen joaten gara. Hirugarren kilometro inguruan <b>iturri</b> batera iristen gara; hemen bide nagusia utzi eta eskuinera biratzen dugu, asfaltozko errepide batetik gora hasteko. Igotzen jarraitzen dugu, jatetxe baten ondotik pasatuz, eta aurrerago asfaltoa utzi eta pista zabalago batean sartzen gara. Hemendik aurrera ibilbideak bestelako itxura hartzen du: pista batzuk lotuz, igoera luze baina erosoa egiten da, eta altuera poliki-poliki irabazten dugu <b>Lekoitzgane</b>ko gainera hurbildu arte.</p>',
    ...
    '    <p>Arriba llegamos a la zona de Atxagarai, donde encontramos una fuente, una bolera y el refugio. Es un buen sitio para parar un momento, beber algo y coger agua antes de seguir.</p>':
        '<p>Gainean, gurutzatu eta <b>Atxagarai</b>ko eta <b>Santa Eufemia</b>ko porlanezko errepidea hartzen dugu. Metroak irabazten jarraitzen dugu, eta paisaia irekitzen doa, basoa atzean utzi eta ikuspegi zabalagoak agertzen diren heinean. Goiko aldean Atxagaraiko eremura iristen gara: iturri bat, bolatoki bat eta aterpea daude, atseden hartzeko leku aproposa. Ura hartu, zerbait jan eta arnasa hartzeko momentu ona izaten da.</p>',
    '    <p>Desde el refugio giramos a la derecha y entramos en una pista que nos lleva hacia la ermita de Santa Eufemia, situada en lo alto de <b><a href="urregarai.html">Urregarai</a></b> &mdash;si seguimos de frente en vez de girar, se baja por el otro lado hasta Markina igualmente&mdash;. La parte final tiene mucho encanto, con la roca caliza y una escalinata de piedra de unos 222 pelda&ntilde;os que termina junto a la ermita. Es un lugar con mucha historia y muy conocido en la zona, especialmente por la romer&iacute;a de Santa Eufemia que se celebra cada septiembre.</p>\n'
    '    <p>Si el d&iacute;a est&aacute; despejado, merece la pena quedarse un rato arriba. Las vistas son muy amplias, pr&aacute;cticamente de 360 grados, y desde aqu&iacute; se domina buena parte de <b>Lea-Artibai</b>, la costa y muchas de las monta&ntilde;as del interior.</p>':
        '<p>Aterpetik eskuinera hartuta, pista batean sartzen gara, eta hortik <b><a href="urregarai.html">Urregarai</a></b>ko gainean dagoen Santa Eufemiako ermitaraino igotzen gara &mdash;biratu beharrean aurrera jarraituz gero, beste aldetik ere Markinara jaisten da&mdash;. Azken zatia berezia da: kareharrizko haitzak eta 222 mailako harrizko eskailera luzea, ermitaren ondoan amaitzen dena. Leku honek historia handia dauka, eta inguruan oso ezaguna da, batez ere irailean ospatzen den erromeriagatik. Eguna garbi bada, goian gelditzea merezi du. Ikuspegia ia 360 gradukoa da, eta hemendik <b>Lea-Artibai</b>ko zati handi bat, kostaldea eta barnealdeko mendiak ederki ikusten dira.</p>',
    ...
    '    <p>La &uacute;ltima parte ya es mucho m&aacute;s sencilla. Seguimos la carretera pr&aacute;cticamente todo el tiempo, en descenso, hasta volver a Markina-Xemein. No tiene demasiado misterio, aunque conviene bajar con cuidado, sobre todo en las curvas y en los tramos donde podamos encontrarnos alg&uacute;n coche.</p>':
        '<p>Gailurrean tarte bat pasatu ondoren, bidea desegin eta berriro jaisten gara errepide nagusira, Lekoitzganeko ingurura. Ezkerrera hartu eta Markinarantz itzultzen gara. Azken zatia askoz errazagoa da: errepideari jarraitzen diogu ia denbora guztian, jaitsieran, herrira iritsi arte. Ez du misterio handirik, baina kontuz ibili behar da, batez ere bihurguneetan eta autoak ager daitezkeen tokietan.</p>',
    '    <p>En conjunto es una vuelta muy agradecida, con una subida larga pero entretenida y una parte final en Santa Eufemia que compensa de sobra el esfuerzo.</p>':
        '<p>Oro har, ibilbide oso atsegina da: igoera luzea baina entretenigarria, tarte politak, goiko aldean paisaia zabalak eta Santa Eufemian amaiera zoragarria. Ahalegina sobera konpentsatzen duen ibilbidea da.</p>',
}
...
MARKINABOLIBAR = {
    ...
    'alt="Zona de merendero con mesas y papeleras junto al camino, entre &aacute;rboles"':
        'alt="Jatordu-eremua mahaiekin eta zaborrontziekin bidearen ondoan, zuhaitzen artean"',
    'alt="Pista de tierra hacia una cresta caliza, con una cantera visible al fondo"':
        'alt="Lurrezko pista harkaiztar gailur baterantz, harrobia hondoan ikusgai"',
    'alt="Sendero de tierra junto al r&iacute;o, entre &aacute;rboles"':
        'alt="Lurrezko bidexka ibaiaren ondoan, zuhaitzen artean"',
    'alt="Carretera asfaltada de bajada con vistas al valle y un caser&iacute;o de tejado rojo al fondo"':
        'alt="Errepide asfaltatua behera, haranaren bista eta teilatu gorriko baserri bat hondoan"',
    'alt="Pasarela de madera sobre un arroyo, en un bosque frondoso de helechos"':
    ...
    'Como en la ruta de <a href="sancristobaloiz.html">San Crist&oacute;bal (Oiz), Zenarruza y Muniozguren</a>, salimos de <b>Trabakua</b> y subimos por <b>Gerea</b> hasta el caser&iacute;o de <b><a href="muniozguren.html">Muniozguren</a></b> (540 m). Desde all&iacute; bajamos hacia el monasterio de <b><a href="zenarruza.html">Zenarruza</a></b> (km 8,97 &middot; 312 m), donde empieza de verdad esta ruta.':
        '<a href="sancristobaloiz.html">San Kristobal (Oiz), Zenarruza eta Muniozguren</a> ibilbidean bezala, <b>Trabakua</b>tik abiatu eta Gereatik gora egiten dugu <b><a href="muniozguren.html">Muniozguren</a></b>go baserriraino (540 m). Handik <b><a href="zenarruza.html">Zenarruza</a></b>ko monasteriorantz jaisten gara (8,97 km &middot; 312 m), eta hor hasten da benetan ibilbide hau.',
    ...
    'Este descenso nos lleva directamente hasta <b>Markina</b> (km 23,06 &middot; 80 m), entrando aproximadamente por la zona de la salida hacia Ondarroa. Pasamos junto a una escuela y atravesamos Markina para buscar de nuevo el Camino de Santiago.':
        'Jaitsiera honek zuzenean <b>Markina</b>raino eramaten gaitu (23,06 km &middot; 80 m), gutxi gorabehera Ondarroarako irteeraren ingurutik sartuz. Eskola baten ondotik pasatzen gara eta Markina zeharkatzen dugu, berriro ere Done Jakue bidea bilatzeko.',
    'Desde Markina seguimos el Camino de Santiago hacia <b><a href="iruzubieta.html">Iruzubieta</a></b> (km 25,46 &middot; 105 m), por un tramo agradable que discurre buena parte del tiempo junto o muy cerca del r&iacute;o. Antes de llegar a Iruzubieta encontramos tambi&eacute;n una fuente junto al mismo camino, por lo que tenemos otro punto donde poder coger agua.':
        'Markinatik <b><a href="iruzubieta.html">Iruzubieta</a></b>rantz jarraitzen dugu Done Jakue bidea (25,46 km &middot; 105 m), zati atsegin batetik, denbora gehienean ibaiaren ondoan edo oso gertu doana. Iruzubietara iritsi aurretik, bidearen ondoan iturri bat ere aurkituko dugu, eta, beraz, ura hartzeko beste puntu bat dugu.',
    'Al llegar a Iruzubieta, junto a un bar, cogemos el tramo que contin&uacute;a hacia Bolibar. A partir de aqu&iacute; el recorrido se pone un poco m&aacute;s costoso, pero tambi&eacute;n m&aacute;s entretenido. Avanzamos entre prados y caser&iacute;os, con ganado en algunos puntos y alguna puerta met&aacute;lica que habr&aacute; que abrir y cerrar.':
...
ASUNTZABIRA = {
    ...
    'Salimos de <b>Trabakua</b> en direcci&oacute;n a Ermua por la carretera general. Antes de llegar a los 2 kil&oacute;metros, como hacemos habitualmente, giramos a la izquierda en <b>Donagarai</b> (km 1,61 &middot; 377 m), junto a un caser&iacute;o, para coger el recorrido hacia Asuntza, dejando atr&aacute;s la carretera y entrando en una zona mucho m&aacute;s tranquila, rodeada de monta&ntilde;as.':
        '<b>Trabakua</b>tik Ermurantz abiatuko gara errepide nagusitik. 2 kilometro egin baino lehen, ohikoa dugun bezala, ezkerretara joko dugu <b>Donagarai</b>ko baserriaren ondoan (1,61 km &middot; 377 m), Asuntzarako bidea hartzeko, errepidea atzean utziz eta mendiz inguratutako eremu lasaiago batean sartuz.',
    'Desde aqu&iacute; comenzamos a ganar altura hasta llegar a la zona de <b>Arteta</b> (km 3,08 &middot; 484 m). Encontramos un cruce que permite hacer el recorrido en ambas direcciones, aunque nosotros continuamos por la parte alta. Este mismo cruce, y el entorno de Arteta y Asuntza, est&aacute; descrito con m&aacute;s detalle en la ruta <a href="artetaasuntza.html">Arteta, Asuntza y los pasos entre ambos</a>.':
        'Hemendik aurrera, altuera irabazten hasiko gara <b>Arteta</b>ko eremura iritsi arte (3,08 km &middot; 484 m). Bidegurutze bat aurkituko dugu, ibilbidea bi noranzkoetan egiteko aukera ematen duena, baina guk goiko aldetik jarraituko dugu. Bidegurutze hau, eta Arteta eta Asuntzako ingurua, zehatzago deskribatuta daude <a href="artetaasuntza.html">Arteta, Asuntza eta bien arteko pasabideak</a> ibilbidean.',
    'A partir de aqu&iacute; el recorrido se hace m&aacute;s llevadero, con una combinaci&oacute;n de subidas y bajadas que nos lleva hasta el collado de <b>Asuntza</b> (km 5,42 &middot; 486 m).':
        'Hemendik aurrera, ibilbidea erosoagoa bihurtzen da, igoera eta jaitsiera konbinazio batekin, <b>Asuntza</b>ko mendixkara eramango gaituena (5,42 km &middot; 486 m).',
    'Desde el collado viene la bajada hacia <b>Berano Txiki</b> (km 6,25 &middot; 357 m), donde empieza el giro de vuelta. Continuamos despu&eacute;s por <b>Berano</b> (km 7,57 &middot; 332 m) hasta llegar de nuevo al cruce de Arteta (km 9,94 &middot; 489 m), esta vez por la parte baja. En este cruce volvemos a bajar otra vez en direcci&oacute;n a Donagarai, pero solo hasta el primer cruce, en pleno descenso fuerte.':
        'Mendixkatik <b>Berano Txiki</b>rako jaitsiera dator (6,25 km &middot; 357 m), non itzulerako bira hasten den. Ondoren, <b>Berano</b>tik jarraituko dugu (7,57 km &middot; 332 m) Artetako bidegurutzera iritsi arte (9,94 km &middot; 489 m), oraingoan beheko aldetik. Bidegurutze honetan, berriro jaitsiko gara <b>Donagarai</b>rantz, baina lehen bidegurutzeraino bakarrik, jaitsiera gogorrean.',
    'A partir de aqu&iacute; nos desviamos hacia el norte. Cogemos la pista que sale a la derecha, en direcci&oacute;n a Iturreta, pero sin llegar a bajar hasta all&iacute;. Seguimos por la parte alta y avanzamos por una zona bastante desconocida, siempre por pista de piedra limpia y c&oacute;moda.':
        'Hemendik aurrera, iparralderantz desbideratuko gara. Eskuinetara ateratzen den pista hartuko dugu, Iturretara bidean, baina hara jaitsi gabe. Goiko aldetik jarraituko dugu, nahiko ezezaguna den eremu batetik, beti harri garbiz eta erosoaz osatutako pistatik.',
    'En este tramo encontraremos un peque&ntilde;o desprendimiento. Es un paso muy corto, de aproximadamente un minuto, en el que puede resultar algo m&aacute;s inc&oacute;modo pasar con la bicicleta, pero se supera sin ning&uacute;n riesgo. Todo lo dem&aacute;s est&aacute; en muy buenas condiciones y la pista contin&uacute;a limpia.':
        'Zati honetan, luizi txiki bat aurkituko dugu. Pauso oso laburra da, minutu ingurukoa, bizikletarekin pasatzea zertxobait deserosoagoa izan daitekeena, baina arriskurik gabe gainditzen dena. Gainerako guztia oso egoera onean dago eta pistak garbi jarraitzen du.',
    'Al llegar arriba, en el collado (km 12,5 &middot; 512 m), giramos hacia la izquierda y nos metemos en las pistas de la Diputaci&oacute;n. Son pistas poco conocidas, muy entretenidas y bonitas, que nos permiten seguir avanzando hasta bajar pr&aacute;cticamente hasta la carretera general de Trabakua&ndash;Markina.':
        'Gora iristean, mendixkan (12,5 km &middot; 512 m), ezkerretara joko dugu eta Aldundiaren pistetan sartuko gara. Pista nahiko ezezagunak dira, oso entretenigarriak eta politak, Trabakua-Markina errepide nagusiraino ia jaitsi arte aurrera egiteko aukera ematen digutenak.',
    'Antes de llegar a ella giramos a mano izquierda y volvemos a ganar altura para regresar hacia la zona de Trabakua.':
        'Hara iritsi baino lehen, ezkerretara joko dugu eta berriro altuera irabaziko dugu Trabakuako eremura itzultzeko.',
    'Durante el recorrido tendremos adem&aacute;s buenas vistas hacia Anboto, el barrio de Gerea, el barrio de Goita, Oiz y las monta&ntilde;as de alrededor, especialmente desde las zonas m&aacute;s abiertas.':
        'Ibilbidean zehar, gainera, Anbotorantz, Gerea auzorantz, Goita auzorantz, Oiz eta inguruko mendietarantz ikuspegi onak izango ditugu, batez ere eremu irekienetatik.',
...
GEREAOCULTA = {
    ...
    # --- relato ---
    'Esta ruta comienza en <b>Trabakua</b> y nos lleva a descubrir una parte poco conocida del barrio de <b>Gerea</b>, recorriendo pistas, caminos y senderos que esconden rincones realmente interesantes.':
        'Ibilbide hau <b>Trabakua</b>n hasten da eta <b>Gerea</b>ko auzoaren zati ezezagun bat ezagutzera garamatza, pista, bide eta bidexkak zeharkatuz, benetan interesgarriak diren txokoak ezkutatzen dituztenak.',
    'Nada m&aacute;s salir de <b>Trabakua</b> nos dirigimos hacia <b>Gerea</b>. Al llegar a las primeras casas, giramos a la derecha para entrar en el barrio y recorrerlo entero. Es un lugar tranquilo, bonito y con buenas vistas. Al salir por la parte alta tomamos la pista que tenemos de frente y nos internamos en el monte, dejando las mejores panor&aacute;micas hacia la izquierda.':
        '<b>Trabakua</b>tik irten bezain laster, <b>Gerea</b>rantz abiatzen gara. Lehenengo etxeetara iristean, eskuinera biratu eta auzoan sartzen gara, osorik zeharkatzeko. Leku lasaia, polita eta ikuspegi onekoa da. Goiko aldetik irtetean, aurrean dugun pista hartu eta mendian barneratzen gara, panoramika onenak ezkerretara utziz.',
    'Seguimos por la pista hasta encontrar la primera bajada, que arranca a mano izquierda. Al principio parece una bajada sin demasiado misterio, pero enseguida se va poniendo m&aacute;s interesante y acaba convirti&eacute;ndose en un tramo algo t&eacute;cnico. Poco a poco vamos perdiendo altura hasta llegar al r&iacute;o.':
        'Pistatik jarraitzen dugu lehen jaitsiera aurkitu arte, ezkerretara abiatzen dena. Hasieran, misterio handirik gabeko jaitsiera dirudi, baina berehala interesgarriagoa bihurtzen da eta tarte tekniko samarra izaten amaitzen du. Pixkanaka, altuera galtzen dugu ibaira iritsi arte.',
    'Tras cruzar el r&iacute;o, salimos a una pista de piedra y seguimos de frente. Avanzamos junto al r&iacute;o en la misma direcci&oacute;n y, m&aacute;s adelante, dejamos la pista para girar a la derecha en busca de la ermita.':
        'Ibaia zeharkatu ondoren, harrizko pista batera irten eta aurrera jarraitzen dugu. Ibaiaren ondotik jarraitzen dugu norabide berean, eta, aurrerago, pista utzi eta eskuinera biratzen dugu ermitaren bila.',
    'Subimos hasta la ermita con la intenci&oacute;n de recuperar una antigua ruta de vuelta, pero el camino que quer&iacute;amos utilizar ya no existe. As&iacute; que toca regresar a la pista y continuar por ella hasta llegar a la carretera general, ya muy cerca. La subida a la ermita se puede descartar sin problema.':
        'Ermitara igotzen gara itzulerako antzinako ibilbide bat berreskuratzeko asmoz, baina erabili nahi genuen bidea jada ez da existitzen. Beraz, pistara itzuli eta bertatik jarraitu behar dugu errepide nagusira iritsi arte, oso gertu. Ermitara igotzea arazorik gabe bazter daiteke.',
    'Recorremos aproximadamente un kil&oacute;metro por la carretera general hasta encontrar la entrada del antiguo camino que sube desde <b>Markina</b> hacia <b>Trabakua</b>. Nada m&aacute;s entrar, giramos a la derecha siguiendo el track para bajar de nuevo hacia el r&iacute;o.':
        'Kilometro bat inguru egiten dugu errepide nagusitik, <b>Markina</b>tik <b>Trabakua</b>ra igotzen den antzinako bidearen sarrera aurkitu arte. Sartu bezain laster, eskuinera biratu eta trackari jarraitzen diogu ibaira berriro jaisteko.',
    'Aqu&iacute; empieza una de las partes m&aacute;s interesantes de la ruta: una subida dura y entretenida, asequible con e-bike y que exige apretar en varios puntos. El esfuerzo merece la pena: una vez arriba, la satisfacci&oacute;n es grande y descubrimos otra zona muy poco transitada.':
        'Hemen hasten da ibilbidearen zatirik interesgarrienetako bat: igoera gogor eta entretenigarria, e-bikearekin egiteko modukoa eta hainbat puntutan gogor aritzea eskatzen duena. Ahaleginak merezi du: behin goian, poz handia sentitzen dugu eta oso gutxi ibilitako beste eremu bat aurkitzen dugu.',
    'Tras recorrer esta parte, cruzamos de nuevo el barrio de <b>Gerea</b> y salimos a la carretera de barrio. Giramos a la derecha y, un par de kil&oacute;metros m&aacute;s adelante, nos desviamos para entrar en la zona de las <b>cascadas de Gerea</b>.':
        'Zati hau zeharkatu ondoren, <b>Gerea</b>ko auzoa berriro zeharkatu eta auzo-errepidera irten gara. Eskuinera biratu eta, pare bat kilometro aurrerago, desbideratu egiten gara <b>Gereako ur-jauzien</b> eremuan sartzeko.',
    'Comenzamos con una subida suave que poco a poco se va endureciendo. En un punto tendremos que pasar dos alambradas; las dejamos cerradas tal y como est&aacute;n y seguimos. La parte final se pone interesante y, en los &uacute;ltimos metros, puede tocar llevar la bici a mano. Es un tramo corto pero exigente, que merece la pena por llegar hasta aqu&iacute;.':
        'Igoera leun batekin hasten gara, pixkanaka gogortzen dena. Puntu batean bi alanbre-hesi pasatu beharko ditugu; itxita uzten ditugu eta aurrera jarraitzen dugu. Azken zatia interesgarria da, eta azken metroetan bizikleta eskuz eraman beharko dugu agian. Tarte laburra baina zorrotza da, honaino iristeak merezi duena.',
    'Una vez alcanzada la pista transversal, giramos a la izquierda y, tras cruzar una puerta de madera, continuamos subiendo hacia la zona de las cascadas. Esta parte es m&aacute;s suave y entretenida. Dejamos las cascadas a un lado y seguimos por el sendero que los corredores de la <a href="7pago.html">7 Pago Trail</a> recorren en sentido contrario.':
        'Zeharkako pistara iritsitakoan, ezkerrera biratu eta, egurrezko ate bat zeharkatu ondoren, ur-jauzien eremurantz igotzen jarraitzen dugu. Zati hau leunagoa eta entretenigarriagoa da. Ur-jauziak alde batera uzten ditugu eta <a href="7pago.html">7 Pago Trail</a> lasterketako korrikalariek kontrako noranzkoan zeharkatzen duten bidexkatik jarraitzen dugu.',
    'A partir de aqu&iacute; empieza la parte m&aacute;s disfrutona de la ruta. Primero alg&uacute;n peque&ntilde;o sube y baja, pero pronto el recorrido se convierte en una bajada continua, combinando sendero y pista. Es un tramo para disfrutar de la bici y del entorno.':
        'Hemendik aurrera hasten da ibilbidearen zatirik atseginena. Lehenik, igoera eta jaitsiera txiki batzuk, baina laster ibilbidea jaitsiera jarraitu bihurtzen da, bidexka eta pista konbinatuz. Bizikletaz eta inguruneaz gozatzeko tartea da.',
    'Ya cerca de <b>Trabakua</b> enlazamos con el camino que sube hacia <b>Zengotitagane</b>, donde buscamos un sendero muy cuidado, limpio y bonito. Es corto, pero tiene un poco de todo: entretenido, con alg&uacute;n punto t&eacute;cnico y un final intenso que hace que merezca la pena llegar hasta &eacute;l.':
        '<b>Trabakua</b>tik gertu, <b>Zengotitagane</b>ra igotzen den bidearekin lotzen dugu, eta oso zaindutako, garbi eta polita den bidexka bat bilatzen dugu. Laburra da, baina denetik pixka bat du: entretenigarria, puntu tekniko batzuekin eta amaiera bizi batekin, honaino iristeak merezi duena.',
    'Desde aqu&iacute; continuamos hasta enlazar de nuevo con el punto de salida en <b>Trabakua</b>, cerrando una vuelta variada por <b>Gerea</b>, con buenas subidas, bajadas, senderos y rincones que normalmente pasan desapercibidos.':
...
AVISO_LEGAL = {
    ...
    'Para cualquier duda:': 'Zalantzarik baduzu:',
    '<a class="lang-switch" href="aviso-legal.eu.html" hreflang="eu" lang="eu" title="Euskaraz">EU</a>':
        '<a class="lang-switch" href="aviso-legal.html" hreflang="es" lang="es" title="En castellano">ES</a>',
...
MARKINAURJAUZIAK = {
    ...
    'alt="El caser&iacute;o de Trabakua, final de la ruta, con el puente de madera junto a la carretera y montes arbolados al fondo"':
        'alt="Trabakuako baserria, ibilbidearen amaiera, zurezko zubia errepidearen ondoan eta baso-mendiak hondoan"',
    ...
    '    <p>Volvemos a las <b><a href="gerea.html">cascadas de Gerea</a></b>, pero esta vez cambiando el punto de salida. En lugar de empezar en <b>Trabakua</b>, salimos de <b>Markina-Xemein</b> y terminamos en Trabakua. As&iacute; el recorrido sale lineal y, al acabar, queda la opci&oacute;n de coger el autob&uacute;s para volver a Markina.</p>\n    <p>Salimos de <b>Markina-Xemein</b> por el <b>Camino de Santiago</b>, en direcci&oacute;n a <b><a href="iruzubieta.html">Iruzubieta</a></b> y <b><a href="markinabolibar.html">Bolibar</a></b>. Los primeros kil&oacute;metros son muy c&oacute;modos, ideales para ir calentando, con terreno llevadero y alguna subida suave, y en ese tramo pasamos junto a una fuente.</p>':
    ...
    '    <p>Entramos en <b>Iruzubieta</b> y buscamos la zona del bar, junto a la que contin&uacute;a el <b>Camino de Santiago</b>; a partir de ah&iacute; el terreno empieza a subir algo m&aacute;s y vamos entre prados, ganado y caser&iacute;os, con buenas vistas durante buena parte del recorrido, hasta llegar a <b>Bolibar</b>.</p>':
    ...
    '    <p>Al cruzar <b><a href="markinabolibar.html">Bolibar</a></b> pasamos junto a la iglesia, al lado del monumento a <b>Sim&oacute;n Bol&iacute;var</b>. Seguimos por la parte alta del pueblo hasta dar con una carretera, la cogemos hacia la izquierda y continuamos en direcci&oacute;n a <b>Trabakua</b>. Pero la dejamos pronto, al llegar a una fuente: a mano izquierda arranca el camino que busc&aacute;bamos.</p>':
        '    <p><b><a href="markinabolibar.html">Bolibar</a></b> zeharkatzean elizaren ondotik pasatzen gara, <b>Simon Bolibar</b>ren monumentuaren alboan. Herriko goiko aldetik jarraitzen dugu errepide batera atera arte; ezkerrera hartu eta <b>Trabakua</b>rantz jotzen dugu. Baina laster uzten dugu, iturri batera iristean: ezkerretara ateratzen da bilatzen genuen bidea.</p>',
    '    <p>La idea era seguir por ese camino, que llega hasta las cercan&iacute;as del caser&iacute;o <b>Astarlo</b>, pero a mitad de camino nos encontramos unas marcas nuevas y decidimos seguirlas; nos sacaron del trazado previsto y acabamos haciendo una variante distinta.</p>':
    ...
    '    <p>La variante nos acerca a la zona de <b><a href="astarlokoatxa.html">Astarloko Atxa</a></b> por la parte de atr&aacute;s, sin llegar a la cima, y desde ah&iacute; perdemos un poco de altura para coger el camino de cemento que sube desde <b>Bolibar</b> hacia <b><a href="muniozguren.html">Muniozguren</a></b>.</p>':
    ...
    '    <p>As&iacute; llegamos a <b>Muniozguren</b> y seguimos por su parte trasera en direcci&oacute;n a <b><a href="longa.html">Longa</a></b>, por caminos que ya conocemos de otras rutas, y en cuanto empieza la bajada dejamos el camino principal y giramos a la derecha para entrar en un sendero m&aacute;s peque&ntilde;o.</p>':
    ...
    '    <p>Ese sendero enlaza con otro de nuestros recorridos y nos acerca a las <b>cascadas de Gerea</b>, subiendo sin demasiada dificultad hasta llegar a la zona de las cascadas; primero visitamos la de abajo y luego continuamos hasta la superior.</p>':
    ...
    '    <p>A finales de septiembre bajaban con muy poca agua, lo normal despu&eacute;s del verano, pero el sitio merece la pena igual: roca, humedad y mucho musgo. En &eacute;poca de lluvias llevan bastante m&aacute;s agua y el lugar cambia por completo.</p>':
    ...
    '    <p>Desde aqu&iacute; ya solo queda volver hacia <b>Trabakua</b>, perdiendo altura poco a poco hasta terminar junto a la parada del autob&uacute;s. El track acaba justo ah&iacute; a prop&oacute;sito: quien haya salido de Markina puede volver en autob&uacute;s sin repetir el recorrido.</p>':
