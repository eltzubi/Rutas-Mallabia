...
BETZUN = {
    ...
    '<p>Una vez arriba, dejamos a nuestra derecha los e&oacute;licos y la cresta que contin&uacute;a hacia <a href="zengotitagane.html">Zengotitagane</a>. Esta vez no seguimos por all&iacute;, sino que giramos hacia la izquierda y continuamos por la parte alta en direcci&oacute;n a Iturzuri.</p>':
        '<p>Behin goian, eskuinean uzten ditugu haize-sorgailuak eta <a href="zengotitagane.html">Zengotitagane</a> aldera jarraitzen duen gailurra. Oraingoan ez dugu handik jarraitzen, baizik eta ezkerrera biratu eta goiko aldetik jarraitzen dugu Iturzurirantz.</p>',
    '<p>Seguimos pr&aacute;cticamente de frente hasta meternos en el hayedo que vemos delante. Lo atravesamos y, al otro lado, llegamos a la fuente de Iturzuri, situada junto a un peque&ntilde;o refugio. Un buen lugar para hacer una parada y coger agua.</p>':
        '<p>Ia zuzen jarraitzen dugu aurrean ikusten dugun pagadira sartu arte. Zeharkatu eta, beste aldean, Iturzuriko iturrira iristen gara, aterpe txiki baten ondoan dagoena. Toki ona geldialdi bat egin eta ura hartzeko.</p>',
    '<p>Desde este punto tambi&eacute;n tenemos otra posibilidad: si gir&aacute;ramos a la derecha y continu&aacute;ramos hacia la zona de los e&oacute;licos, podr&iacute;amos seguir en direcci&oacute;n a la cima del <a href="oiz.html">Oiz</a>. Nosotros no vamos por all&iacute;. Giramos a la izquierda y subimos los pocos metros que nos separan de <b>Iturzurigaina</b> (km 5,4 &middot; 855 m).</p>':
        '<p>Puntu honetatik beste aukera bat ere badugu: eskuinera biratu eta eolikoen aldera jarraituz gero, <a href="oiz.html">Oiz</a>eko gailurrerantz jarraitu ahalko genuke. Guk ez dugu bide hori hartzen. Ezkerrera biratu eta <b>Iturzurigaina</b>tik bereizten gaituzten metro gutxiak igotzen ditugu (5,4 km &middot; 855 m).</p>',
    '<p>Una vez arriba buscamos la cruz de piedra y, junto a ella, cambiamos completamente de vertiente para comenzar el descenso hacia el sur.</p>':
        '<p>Goian gaudela, harrizko gurutzea bilatzen dugu eta, bertan, isurialdea erabat aldatzen dugu hegoalderantz jaisten hasteko.</p>',
    '<p>La bajada es r&aacute;pida y vamos perdiendo altura con facilidad. M&aacute;s abajo llegamos junto a un haya grande, donde giramos a la derecha y continuamos descendiendo hasta llegar al caser&iacute;o <b>Betzun</b> (km 6,5 &middot; 628 m).</p>':
        '<p>Jaitsiera azkarra da, eta erraz galtzen dugu altuera. Beherago, pago handi baten ondora iristen gara, eta eskuinera biratu eta jaisten jarraitzen dugu <b>Betzun</b> (6,5 km &middot; 628 m) baserrira iritsi arte.</p>',
