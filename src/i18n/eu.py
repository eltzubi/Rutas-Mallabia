...
SANTAEUFEMIA = {
    ...
    '    <p>La &uacute;ltima parte ya es mucho m&aacute;s sencilla. Seguimos la carretera pr&aacute;cticamente todo el tiempo, en descenso, hasta volver a Markina-Xemein. No tiene demasiado misterio, aunque conviene bajar con cuidado, sobre todo en las curvas y en los tramos donde podamos encontrarnos alg&uacute;n coche.</p>':
        '<p>Gailurrean tarte bat pasatu ondoren, bidea desegin eta berriro jaitsiko gara errepide nagusira, Lekoitzganeko ingurura. Ezkerrera hartu eta Markinarantz itzultzen gara. Azken zatia askoz errazagoa da: errepidea jarraitzen dugu ia denbora guztian, jaitsieran, herrira iritsi arte. Ez du misterio handirik, baina kontuz ibili behar da, batez ere bihurguneetan eta autoak ager daitezkeen tokietan.</p>',
