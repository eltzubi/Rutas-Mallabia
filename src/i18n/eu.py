...
OSMA = {
    ...
    '22,4 &middot; 312 m), San Juan Bautista de Murgoitio (km 24,3 &middot; 277 m) &mdash;con registros '
    'del siglo XVII de tumbas dobles nunca excavadas, similares a las de Argi&ntilde;eta&mdash; y San '
    'Antonio de Olakueta (km 25,8 &middot; 160 m), donde se pierde altura de golpe. Gira despu&eacute;s '
    ...
    'en el valle del Ibaizabal, al pie del Oiz.':
        ...
        'Argi&ntilde;etakoen antzekoak&mdash; eta Olakuetako San Antonio (25,8 km &middot; 160 m), non '
